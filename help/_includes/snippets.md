...
## Headless 試用版 (方案已結束) {#headless-trials-promotion}
...
* [使用表單資料模型提交](/help/forms/integrate-adaptive-form-with-fdm.md)
...
<table>
  ...
  <tr>
    ...
    <td>使用規則編輯器的<b>Invoke Service</b>屬性來設定選項下拉式清單。 
   </td>
   </tr>
     </tr>
   <tr>
...
>
>* 使用[快照工具](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-learn/assets/dynamic-media/images/dynamic-media-snapshot)試用 Dynamic Media 影像功能。
>
...
>
>* [通用編輯器](https://www.aem.live/docs/aem-authoring)：用於視覺化編輯 Headless 內容。
