...
1. 點選或按一下您需要啟動的管道旁的省略符號。 從下拉式功能表中選取 **執行**.
...
>[!TIP]
>
>在管道詳細資訊視窗中，您可以點選或按一下 **下載記錄** 用於管道的任意步驟進行偵錯（如果任意步驟失敗）。 管道偵錯超出了此歷程的範圍。 請參閱下列Cloud Manager的技術檔案： [其他資源](#additional-resources) 的區段。
