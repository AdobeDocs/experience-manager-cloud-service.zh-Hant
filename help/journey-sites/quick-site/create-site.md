...
在 AEM 快速建立網站歷程的上一個文件「[了解 Cloud Manager 和快速建立網站工作流程](cloud-manager.md)」中，您已了解 Cloud Manager 以及它與快速建立網站的新流程如何連結在一起，而您現在應該：
...
以此知識為基礎並繼續您的 AEM 快速建立網站歷程，接著檢閱文件「[設定您的管道](pipeline-setup.md)」，您將會建立前端管道來管理網站主題的自訂內容。
