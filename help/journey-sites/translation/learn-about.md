...
>
>如需AEM Sites的詳細資訊及其所有強大功能的詳細資訊，請參閱本文結尾的[其他資訊區段](#additional-information)以取得更多AEM Sites資源。

## 轉譯AEM中的網站內容 {#translating-in-aem}

AEM不僅可讓您輕鬆建立和管理內容，還可讓您輕鬆將內容翻譯給對象（無論對象在何處）。

從高度講，AEM中的翻譯包含四個簡單步驟：
...
根據此知識，接下來檢閱檔案[開始使用AEM Sites翻譯](getting-started.md)，繼續您的AEM Sites翻譯歷程；您將可在此概略了解AEM如何管理內容及了解其翻譯工具。

## 其他資源 {#additional-resources}

雖然建議您檢閱檔案[開始使用AEM Sites翻譯，以繼續進行網站翻譯歷程的下一個階段，但以下是一些額外的選用資源，可深入探討本檔案中提及的一些概念，但您不需要繼續進行歷程。](getting-started.md)

* [製作頁面快速入門手冊](/help/sites-cloud/authoring/getting-started/quick-start.md)  — 使用AEM Sites建立內容最重要概念的快速概述
