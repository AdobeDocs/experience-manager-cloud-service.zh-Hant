...
在AEM Sites翻譯歷程的上一份檔案中， [了解AEM Sites內容及在AEM中的翻譯方式](learn-about.md) 你學到了AEM Sites的基本理論，現在應該：
...
1. 在全域導覽選單中，按一下或點選 **導覽** -> **網站**.
1. 網站主控台會開啟至您內容的頂層。
1. 請確定 **欄檢視** 會使用視窗右上角的檢視選取器來選取。
...
1. 點選或按一下左上方的邊欄選取器，您也可以顯示 **內容樹** 檢視，以檢視內容的樹狀檢視。
...
借由下次檢閱此檔案，繼續您的AEM Sites翻譯歷程 [配置翻譯連接器](configure-connector.md) 您將學習如何將AEM連線至翻譯服務。|

## 其他資源 {#additional-resources}

不過，建議您透過檢閱檔案，繼續進行翻譯歷程的下一個階段 [配置翻譯連接器](configure-connector.md) 以下是一些額外的選用資源，可更深入探討本檔案中提及的一些概念，但您不需要這些資源即可繼續進行歷程。
