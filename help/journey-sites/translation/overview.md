...
此歷程專為翻譯專家人物誌 (通常稱為翻譯專案經理或 TPM) 所設計。此歷程闡述翻譯 AEM Sites 內容的要求、步驟和方法。此歷程定義了翻譯專家必須與之互動的其他人物誌，但此歷程是以翻譯專家的角度出發。
...
| 2 | [開始使用 AEM Sites 翻譯](getting-started.md) | 了解如何組織網站內容以及 AEM 翻譯工具的運作原理。 |
