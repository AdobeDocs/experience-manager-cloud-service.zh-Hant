...
在AEM Sites翻譯歷程的上一份檔案中，「[翻譯內容」(](configure-connector.md))您學會了如何使用AEM翻譯專案來翻譯您的內容。 您現在應該：
...
1. 導覽至&#x200B;**導覽** -> **資產** -> **檔案**。 請記住，AEM中的內容儲存在`/content`下。
1. 選取專案的語言根目錄。 在此情況下，我們已選擇`/content/wknd/en`。
...
您現在可以在AEM中翻譯自己的內容。 不過，AEM是功能強大的工具，有許多其他選項可供使用。 查看[其他資源區段](#additional-resources)中提供的其他資源，深入了解您在此歷程中看到的功能。
