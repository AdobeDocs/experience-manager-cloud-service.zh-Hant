...
* **翻譯工作** - 這張或這些卡片顯示實際翻譯工作的概觀，包括狀態、資產數量等。通常，每種語言都有一個工作，工作名稱後面附加了 ISO-2 語言代碼。
   * 當[自動建立翻譯工作](#automatically-creating)時，AEM會以非同步方式建立工作，而且這些工作可能不會立即出現在專案中。
...
>[!NOTE]
>
>如果您未停用專案選項&#x200B;**促銷活動後刪除啟動** （如上一節](#using-translation-project)所述），則已翻譯專案會以&#x200B;**已刪除**&#x200B;狀態出現。 [這是正常現象，因為翻譯項目到達後，AEM 會自動丟棄翻譯記錄。已翻譯的項目已匯入為語言副本，僅刪除不再需要的翻譯記錄。
>
...
我們建議您檢閱檔案[Publish已翻譯內容](publish-content.md)，以繼續翻譯歷程的下一部分，以下是一些其他選擇性資源，這些資源會更深入地研究本檔案中提到的一些概念，但並非繼續此歷程所必需的。
