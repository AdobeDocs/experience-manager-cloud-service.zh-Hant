...
* SITES-28051：取得目前使用者對內容片段的權限：GET /cf/fragments/{fragmentId}/permissions。
...
* SITES-29602：CIF：移除core-cif-components-core中的Guava使用量。
* SITES-25785： CIF：新增CIF產品參考資料型別的產品變體選擇。
* SITES-26392： CIF[實驗性]： PDP中CIF核心元件的JSON+LD。
* SITES-21278： CIF[實驗性]： CIF清除快取的能力。
...
* SITES-24631： CIF：產品欄位發生搜尋問題。
* SITES-24902： CIF：產品URL格式無法如#variant_sku預期運作。
* SITES-29191： CIF：無法新增超過20個SKU至產品清單元件。
