---
title: 與 2023.2.0 功能啟用相關聯的  [!DNL Adobe Experience Manager]  as a Cloud Service 維護版本注意事項。
description: 與 2023.2.0 功能啟用相關聯的  [!DNL Adobe Experience Manager]  as a Cloud Service 維護版本注意事項。
...
下節是與 2023.2.0 功能啟用相關聯的 Experience Manager as a Cloud Service 維護版本的技術版本注意事項。
...
- SITES-13256 — 配置了特殊URL分頁呈現的核心WCM預告
- GRANITE-45462 — 消息客戶端多區域配置
- GRANITE-45562 — 影像組合返回200而不是404的問題
