---
title: 與 2026.1.0 功能啟用相關聯的  [!DNL Adobe Experience Manager]  as a Cloud Service 維護版本發行說明。
description: 與 2026.1.0 功能啟用相關聯的  [!DNL Adobe Experience Manager]  as a Cloud Service 維護版本發行說明。
...
以下章節概述與 2026.1.0 功能啟用相關聯之 Experience Manager as a Cloud Service 維護版本的技術版本發行說明。

## 23963 版 {#23963}

以下摘要說明維護版本23963數的持續改善，該版本於2026年1月8日公開發佈。 前一個維護版本是 23482 版。

2026.1.0 功能啟用會提供此維護版本的完整功能集。如需詳細資訊，請參閱 [Experience Manager 發行路徑圖](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap)。
...
* Forms-20536：在規則編輯器中公開eventPayload中完整回應的選項，但不進行對應。
...
* SITES-8113：「工具」功能表中的「範本」的「選取影像」對話方塊中，「Assets」字串未本地化。
