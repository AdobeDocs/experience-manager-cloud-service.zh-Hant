...
[!DNL Adobe Experience Manager] as a [!DNL Cloud Service] 最新功能版本 (2025.1.0) 的發行日期為 2025 年 1 月 30 日。下一個功能版本(2025.2.0)計畫於2025年3月4日發行。
...
您可以使用[管理發佈](/help/forms/manage-publication.md#publish-forms-using-the-manage-publication-option)工作流程在多個環境間發佈或取消發佈表單，通常是從製作執行個體到發佈和預覽執行個體。此功能讓使用者可以用精簡的方式發佈、取消發佈或排程內容發佈。
