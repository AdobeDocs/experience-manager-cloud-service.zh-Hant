...
[!DNL Adobe Experience Manager]作為[!DNL Cloud Service]目前功能版本(2026.1.0)的發行日期是2026年1月29日。 下一個功能版本(2026.2.0)計畫於2026年3月3日發行。
...
請觀看 2026 年 1 月發行概觀影片，了解 2026.1.0 版本新增功能摘要：

>[!VIDEO](https://video.tv.adobe.com/v/3479800/?captions=chi_hant&quality=12)
...
* 現在，無論相關面板的可見度為何，註腳都會持續顯示在註腳預留位置內，確保關鍵資訊的存取方式維持一致。
  ![註腳描述](/help/forms/assets/footnote-description.png){height=50%}
