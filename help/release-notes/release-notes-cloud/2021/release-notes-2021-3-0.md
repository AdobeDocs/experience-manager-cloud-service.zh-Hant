...
description: '[!DNL Adobe Experience Manager] as a Cloud Service 2021.3.0版發行說明。'
...
[!DNL Adobe Experience Manager] as a Cloud Service 2021.3.0的發行日期為2021年3月25日。
...
您可以使用[AEM Forms as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-forms-cloud-service/forms/home.html)建立數位表格、將表格連結到現有的資料來源、將表格與Adobe Sign整合以將電子簽章新增至表格、產生記錄檔案(DoR)以將提交的表格封存為PDF檔案。 此服務也可以將您現有的PDF forms轉換為數位表格。 除了標準AEM Forms功能外，此服務也提供幾個雲端原生功能，像是自動縮放、升級時的零停機時間，以及雲端原生開發環境。
...
* Cloud Manager 生產管道現在包含[自訂 UI 測試](/help/implementing/cloud-manager/functional-testing.md#custom-ui-testing)功能。
