...
+ 網站 {#sites}
   ...
   + 整合 AEM as a Cloud Service {#integrations}
      ...
      + [與Adobe Campaign整合](/help/sites-cloud/integrating/campaign.md)
+ 資產 {#assets}
   ...
   + 管理數位資產 {#manage}
      ...
      + [管理PDF檔案](/help/assets/manage-pdf-documents.md)
...
+ 表單 {#forms}
   ...
   + 整合 {#integrate}
      ...
      + [在AEM Sites中內嵌適用性Forms](/help/forms/embed-adaptive-form-aem-sites.md)
