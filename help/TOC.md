...
+ AEMas a Cloud Service遷移 {#migration-journey}
   ...
   + 遷移工具發行說明 {#release-notes-migration-tools}
      + [最新發行說明 (2022.1.0)](/help/journey-migration/release-notes/release-notes-migration-tools-current.md)
      + 2021 {#2021}
...
+ 網站 {#sites}
   ...
   + 製作 {#authoring}
      ...
      + 製作基礎知識 {#fundamentals}
         ...
         + [體驗片段 — 導出](/help/sites-cloud/authoring/fundamentals/experience-fragments-target.md)
...
+ 表單 {#forms}
   ...
   + 使用通訊{#using-communications}
      ...
      + [通信API批處理](/help/forms/aem-forms-cloud-service-communications-batch-processing.md)
