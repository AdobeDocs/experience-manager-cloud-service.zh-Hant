...
+ 發行說明 {#release-notes}
   ...
   + 遷移工具發行說明 {#migration-tools}
      + [當前發行說明](/help/journey-migration/release-notes/release-notes-migration-tools-current.md)
      + 2022 {#2022}
   ...
   + WorkfrontExperience Manager增強連接器發行說明{#workfront}
      + [WorkfrontExperience Manager增強連接器的當前發行說明](/help/assets/release-notes-enhanced-connector-workfront.md)
...
+ 網站 {#sites}
   ...
   + 製作 {#authoring}
      ...
      + 行銷活動 {#campaign}
         + [使用建立新聞稿AEM](/help/sites-cloud/authoring/campaign/creating-newsletters.md)
   + 管理 {#administering}
      + 內容片段 {#content-fragments}
         ...
         + [內容片段控制台 — 鍵盤快捷鍵](/help/sites-cloud/administering/content-fragments/content-fragments-console-keyboard-shortcuts.md)
      + 網站建立 {#site-creation}
...
+ 資產 {#assets}
   ...
   + 配置、管理和擴展 [!DNL Assets] {#admin}
      ...
      + [配置資產上載限制](/help/assets/configure-asset-upload-restrictions.md)
   ...
   + 動態媒體 {#dynamicmedia}
      ...
      + [具有客戶端設備像素比的智慧成像](/help/assets/dynamic-media/client-side-dpr.md)
   ...
   + 與Adobe Workfront {#integrations}
      ...
      + [配置資產元資料映射](/help/assets/configure-asset-metadata-mapping.md)
+ 表單 {#forms}
...
+ 無頭 {#headless}
   ...
   + 內容片段 {#content-fragments}
      ...
      + [內容片段控制台](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/sites/administering/content-fragments/content-fragments-console.html)
