...
description: 了解關於連接器、這類工具的功能，以及如何在 Experience Manager 中實施這些重要工具。
landing-page-description: 了解關於連接器、這類工具的功能，以及如何在 Experience Manager 中實施這些重要工具。
...
了解Connectors forExperience Manageras a Cloud Service、其功能，以及如何在Experience Manager中實作這些寶貴工具。
...
| 使用手冊 | 說明 |
|---|---|
| [概覽](/help/overview/home.md) | 本指南提供Experience Manager as a Cloud Service的簡介，包括簡介、術語、架構等。 |
