...
landing-page-description: 了解關於連接器、這類工具的功能，以及如何在 Experience Manager 中實作這些重要工具。
...
# 實作 Experience Manager as a Cloud Service 的連接器 {#aem-connectors-guide}

了解 Connectors for Experience Manager as a Cloud Service、其功能以及如何在 Experience Manager 實施這些重要工具。
...
| 使用手冊 | 說明 |
|---|---|
| [概觀](/help/overview/home.md) | 本指南以概觀方式介紹 Experience Manager as a Cloud Service，包括簡介、術語和架構等。 |
