---
title: Adobe Experience Manager as a Cloud Service 使用手冊
description: Adobe Experience Manager as a Cloud Service 自助資源與文件連結
...
# Experience Manager as a Cloud Service 使用手冊 {#aem-user-guide}

此頁面提供 Experience Manager as a Cloud Service 的自助使用手冊。

## Experience Manager as a Cloud Service 指南 {#aem-guides}

| 使用手冊 | 說明 |
|---|---|
| [概覽](/help/overview/home.md) | 如需Experience Manager as a Cloud Service的概觀，包括簡介、術語、架構等，請從這裡開始。 |
...
| [商務使用手冊](/help/commerce-cloud/home.md) | 了解如何使用及管理 Experience Manager Commerce as a Cloud Service。 |
...
| [合規性使用手冊](/help/compliance/home.md) | 了解AEM as aCloud Service中的法規遵循。 |
...
* [Cloud Manager 文件](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/onboarding/getting-access/navigation.html)
