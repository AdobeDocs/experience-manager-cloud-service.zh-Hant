...
可與Salesforce Commerce等商業商業解決方案整合。 請洽詢您的Adobe代表。
...
>[!NOTE]
>
>現有客戶若想使用新的AEM / Commerce功能，應將其網站移至Edge Delivery。 常見的模式是先僅將一部分頁面移至Edge Delivery，然後並排執行Edge Delivery和CIF頁面。 您也可以使用新的[AEM CIF增益集元件](https://experienceleague.adobe.com/developer/commerce/storefront/dropins/all/introduction/?lang=zh-Hant)來取代Commerce元件，以運用新的Commerce功能。
