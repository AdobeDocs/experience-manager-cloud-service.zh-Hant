...
>[!NOTE]
>
>有關 AEM 6.5 的 AEM Content and Commerce 和傳統 CIF，請參閱 [AEM 6.5 Content and Commerce](https://experienceleague.adobe.com/docs/experience-manager-65/commerce/home.html)。

## 重要的 Content and Commerce 文章 {#key-articles}

* [AEM Content and Commerce 簡介](introduction.md)
* [AEM Content and Commerce 快速入門](/help/commerce-cloud/getting-started.md)
* [開發 AEM Content and Commerce](/help/commerce-cloud/develop.md)
