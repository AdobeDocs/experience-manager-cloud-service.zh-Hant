...
在AEM內容和Commerce歷程的上一個檔案[管理產品目錄頁面和範本](/help/commerce-cloud/cif-storefront/commerce-journeys/aem-commerce-content-author/catalog-templates.md)中，您已瞭解如何根據範本管理和建置產品目錄體驗。
...
>[!NOTE]
>
>此功能僅適用於Adobe Commerce或Cloud Edition，以及支援權杖式驗證的協力廠商聯結器。 如需詳細資訊，請參閱[快速入門](/help/commerce-cloud/cif-storefront/getting-started.md)。
...
AEM啟動可讓您建立分階段產品資料的內容。 如果您不熟悉Launch，請依照「[其他資源」區段下的檔案連結操作。](#additional-resources)然後會使用啟動日期來存取分階段的產品資料。
...
您現在已準備好管理[產品體驗。](/help/commerce-cloud/cif-storefront/commerce-journeys/aem-commerce-content-author/product-experience-management.md)不過，AEM內容和Commerce有許多其他可用選項。 查看[其他資源區段](#additional-resources)提供的一些其他資源，以詳細了解您在此歷程中看到的功能。
