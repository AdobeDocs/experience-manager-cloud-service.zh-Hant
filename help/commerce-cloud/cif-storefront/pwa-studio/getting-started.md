...
![PWA headless架構](/help/commerce-cloud/cif-storefront/assets/PWA-Studio_Architecture.png)
...
1. 將Apollo連結包裝函式新增至您的PWA Studio應用程式。 在`pwa-root/src/index.js`中進行下列變更：
   ...
   您可以在[linkWrapper.js.](https://github.com/adobe/aem-pwa-studio-extensions/blob/master/aem-cfm-blog-extension/extension/src/linkWrapper.js)中找到更多有關阿波羅使用者端自訂的詳細資料

1. 若要使用Blog專案擴充導覽元件，請在`pwa-root/local-intercept.js`中新增下列改寫專案：
...
您可以在[這裡](https://github.com/adobe/aem-pwa-studio-extensions/tree/master/aem-cfm-blog-extension/aem/config/src/main/content/jcr_root/apps/blog-demo/config)找到這兩種設定的完整範例。
