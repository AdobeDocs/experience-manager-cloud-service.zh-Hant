...
description: 購物車和 Dispatcher 設定
...
[AEM CIF核心元件](https://github.com/adobe/aem-core-cif-components)隨附立即可用的[購物車](https://github.com/adobe/aem-core-cif-components/tree/master/ui.apps/src/main/content/jcr_root/apps/core/cif/components/commerce/minicart/v1/minicart)，可呈現購物車和結帳表單。 購物車需要具有GraphQL[路由設定的](https://github.com/adobe/aem-core-cif-components/blob/master/dispatcher)AEM Dispatcher。 以下影片詳細介紹本機設定，以及使用Docker影像進行設定。
