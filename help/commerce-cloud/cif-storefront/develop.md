...
根據AEM as a Cloud Service適用的Commerce integration framework (CIF)開發AEM Commerce專案，會遵循與AEM as a Cloud Service上其他AEM專案相同的規則和最佳實務。 請先檢閱下列內容：
...
>檢視[使用AEM as a Cloud Service SDK設定本機開發環境的詳細指南。](https://experienceleague.adobe.com/docs/experience-manager-learn/cloud-service/local-development-environment-set-up/overview.html?lang=zh-Hant)
