...
儘管您可以直接進入歷程的特定部分，但許多概念都是以先前文章中的概念為基礎。因此，如果您是 AEM Headless 新手，我們建議您從頭開始，然後按順序進行。

| # | 文章 | 說明 |
|---|---|---|
| 0 | AEM Headless 內容作者歷程 | 本文件 |
| 1 | [AEM Headless as a Cloud Service 編寫 - 簡介](introduction.md) | 介紹 Adobe Experience Manager as a Cloud Service 的 Headless 功能，以及如何為您的專案編寫內容。 |
...
您現在已準備好開始您的 Adobe Headless 歷程。我們鼓勵您繼續歷程的下一部分並閱讀文章[AEM Headless as a Cloud Service 編寫 - 簡介。](introduction.md)
