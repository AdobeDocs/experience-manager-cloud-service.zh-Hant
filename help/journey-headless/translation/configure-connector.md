...
1. 提供下列資訊。
   ...
   1. **禁用僅更新翻譯**  — 選中此選項後，更新翻譯項目將提交所有可翻譯的欄位以供翻譯，而不只是上次翻譯後更改的欄位。 更新翻譯專案的相關討論稍後會在歷程中進行。
   1. **啟用翻譯的內容模型欄位**  — 核取此選項，讓翻譯設定能根據 **可翻譯** 標籤。
...
基於此知識，接下來檢閱此檔案，繼續您的AEM無頭翻譯歷程 [翻譯內容，](translation-rules.md) 您將在何處學習如何使用您的設定來實際翻譯您的內容。
