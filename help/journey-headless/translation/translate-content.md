...
在前一篇無頭AEM翻譯旅程中， [配置翻譯連接器](configure-connector.md) 您瞭解了中的翻譯框架AEM。 您現在應該：

* 瞭解中翻譯整合框架的重要參AEM數。
* 能夠設定自己與翻譯服務的連接。

現在已設定連接器，本文將引導您完成翻譯無頭內容的下一步。

## 目標 {#objective}

本文檔幫助您瞭解如何使用翻譯項AEM目以及連接器來翻譯內容。 閱讀此文檔後，您應：
...
自動建立翻譯項目時，AEM將評估所選路徑下的無頭內容。 根據這一評估，它提取需要翻譯的內容，並將其轉換為新的翻譯項目。 我知道根據標籤為 **可翻譯** 內容架構師。
