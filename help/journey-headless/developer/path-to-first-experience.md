...
在AEM無頭歷程的上一份檔案中， [AEM Headlessas a Cloud Service快速入門](getting-started.md) 您學到了無頭式CMS的基本理論，現在應該：
...
繼續處理本檔案之前，請確定您已檢閱AEM Headless Developer Journey中的先前檔案， [AEM Headlessas a Cloud Service快速入門](getting-started.md) 請確定您：
...
與AEM分開，如果您要建置用戶端應用程式，以便針對對AEMas a Cloud Service的API呼叫測試用戶端，也請確定您已設定正確的開發環境。
...
* [AEM Sitesas a Cloud Service無頭開發](/help/headless/introduction.md)  — 快速介紹如何指定AEM Headless開發人員及其所需功能
...
* [無頭設定](/help/headless/introduction.md#getting-started)  — 為熟悉AEM的使用者快速介紹AEM無頭功能。
* [建立內容片段模型](/help/sites-cloud/administering/content-fragments/content-fragments-models.md)  — 內容片段模型的技術檔案
* [建立內容片段](/help/sites-cloud/administering/content-fragments/content-fragments.md)  — 內容片段的技術檔案
* [使用GraphQL查詢內容](/help/headless/graphql-api/content-fragments.md) - GraphQL API的技術檔案
