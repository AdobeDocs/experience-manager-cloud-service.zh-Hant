...
+ 發行說明 {#release-notes}
   ...
   + AEMaaCS 功能發行說明 {#release-notes}
      ...
      + 2026 {#2026}
         + [2026.3.0版發行說明](/help/release-notes/release-notes-cloud/2026/2026-3-0.md)
   ...
   + AEMaaCS 維護版本發行說明 {#maintenance}
      ...
      + 2026 {#2026}
         + [2026.4.0版維護發行說明](/help/release-notes/maintenance/2026/2026-4-0.md)
         + [2026.3.0版維護發行說明](/help/release-notes/maintenance/2026/2026-3-0.md)
         + [2026.2.0版維護發行說明](/help/release-notes/maintenance/2026/2026-2-0.md)
         + [2026.1.0版維護發行說明](/help/release-notes/maintenance/2026/2026-1-0.md)
      + 2025 {#2025}
         + [2025.12.0 維護版本發行說明](/help/release-notes/maintenance/2025/2025-12-0.md)
         + [2025.11.0 維護版本發行說明](/help/release-notes/maintenance/2025/2025-11-0.md)
      ...
      + 2023 {#2023}
         ...
         + [2023.10.0版維護發行說明](/help/release-notes/maintenance/2023/2023-10-0.md)
   ...
   + 通用編輯器發行說明 {#universal-editor}
      ...
      + 2026 {#2026}
         + [2026.04.30版本注意事項](/help/release-notes/universal-editor/2026/2026-04-30.md)
         + [2026.04.09版發行說明](/help/release-notes/universal-editor/2026/2026-04-09.md)
         + [2026.04.02發行說明](/help/release-notes/universal-editor/2026/2026-04-02.md)
         + [2026.03.26版本注意事項](/help/release-notes/universal-editor/2026/2026-03-26.md)
         + [2026.03.19版發行說明](/help/release-notes/universal-editor/2026/2026-03-19.md)
         + [2026.03.12發行說明](/help/release-notes/universal-editor/2026/2026-03-12.md)
         + [2026.03.05版本注意事項](/help/release-notes/universal-editor/2026/2026-03-05.md)
         + [2026.02.26版本注意事項](/help/release-notes/universal-editor/2026/2026-02-26.md)
         + [2026.02.19版發行說明](/help/release-notes/universal-editor/2026/2026-02-19.md)
         + [2026.02.13發行說明](/help/release-notes/universal-editor/2026/2026-02-13.md)
         + [2026.02.05版本注意事項](/help/release-notes/universal-editor/2026/2026-02-05.md)
         + [2026.01.29版發行說明](/help/release-notes/universal-editor/2026/2026-01-29.md)
         + [2026.01.22發行說明](/help/release-notes/universal-editor/2026/2026-01-22.md)
         + [2026.01.15 發行說明](/help/release-notes/universal-editor/2026/2026-01-15.md)
      + 2025 {#2025}
         + [2025.12.12 發行說明](/help/release-notes/universal-editor/2025/2025-12-12.md)
         + [2025.12.04 發行說明](/help/release-notes/universal-editor/2025/2025-12-04.md)
         + [2025.11.20 發行說明](/help/release-notes/universal-editor/2025/2025-11-20.md)
...
+ 安全性 {#security}
   ...
   + [網路連線測試](/help/security/network-connectivity-test.md)
   ...
   + [移轉至外部身分和動態群組成員資格](/help/security/migrating-to-external-identity.md)
...
+ Sites {#sites}
   ...
   + 管理 {#administering}
      + 內容片段 {#content-fragments}
         + [概念與最佳實務](/help/sites-cloud/administering/content-fragments/overview.md)
         ...
         + [使用MSM重複使用內容片段](/help/sites-cloud/administering/content-fragments/msm-for-content-fragments.md)
      ...
      + 重複使用內容 {#reusing-content}
         ...
         + 翻譯 {#translation}
            ...
            + [設定AI翻譯整合](/help/sites-cloud/administering/translation/ai-translation-integration.md)
...
+ Assets {#assets}
   ...
   + 共用與發佈資產 {#brand-portal}
      ...
      + [從 [!DNL Brand Portal] 發佈資產到 [!DNL Assets]](https://experienceleague.adobe.com/docs/experience-manager-brand-portal/using/asset-sourcing-in-brand-portal/brand-portal-asset-sourcing.html?lang=zh-hant)

   + 內容顧問 {#content-advisor}
      + [內容警告器，可存取Adobe和非Adobe應用程式中的AEM內容](/help/assets/integrate-adobe-non-adobe-applications.md)
      + [內容警告器屬性](/help/assets/content-advisor-properties.md)
      + [內容建議程式自訂](/help/assets/content-advisor-customization.md)
      + [整合Dynamic Media與OpenAPI功能](/help/assets/integrate-dynamic-media-open-api.md)
   + 內容片段 {#content-fragments}
   ...
   + Dynamic Media {#dynamicmedia}
      ...
      + [新視訊檢視器](/help/assets/dynamic-media/new-video-viewer.md)
      ...
      + 具有 OpenAPI 功能的 Dynamic Media {#dynamic-media-open-apis}
         ...
         + [快取管理](/help/assets/cache-management-dynamic-media-open-api.md)
   + 使用資產視圖 {#assets-view}
...
+ Forms {#forms}
   ...
   + 整合 {#integrate}
      ...
      + 表單資料模型 {#use-form-data-model}
         ...
         + [將最適化表單連線至Azure SQL資料庫](/help/forms/connect-adaptive-form-to-azure-sql.md)
      ...
      + 設定自適應表單的提交動作 {#set-submit-action}
         ...
         + 將自適應表單連結到 Microsoft® SharePoint{#connect-to-sharepoint}
            + [將自適應表單連結到 Microsoft® SharePoint](/help/forms/configure-submit-action-sharepoint.md)
   ...
   + 自適應表單 {#adaptive-forms-authoring}
      ...
      + [在Forms Manager中管理表單Assets版本](/help/forms/manage-form-versions-forms-manager.md)
      + 核心元件 {#authoring-adaptive-forms-core-components}
         + 建立自適應表單 {#create-an-adaptive-form-on-forms-cs}
            ...
            + [使用主題編輯器自訂最適化表單主題](/help/forms/customizing-themes-using-theme-editor.md)
      ...
      + Foundation 元件 {#authoring-adaptive-forms-foundation-components}
         + 將您的 PDF 表單轉換為自適應表單 {#afcs}
            ...
            + [將現有PDF表單轉換為最適化表單](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html?lang=zh-hant)
...
+ 互動式通訊 {#interactive-communication}
   ...
   + 元件 {#component}
      + [文字方塊](/help/forms/interactive-communication/text-box.md)
      + [影像](/help/forms/interactive-communication/image.md)
      ...
      + [條碼](/help/forms/interactive-communication/barcode.md)
   + 操作說明 {#howto}
      + [設定資料繫結](/help/forms/interactive-communication/configure-data-binding.md)
      + [使用規則編輯器](/help/forms/interactive-communication/use-the-rule-editor.md)
      + [匯入和匯出互動式通訊](/help/forms/interactive-communication/import-and-export-the-interactive-communication.md)
      + [新增自訂字型](/help/forms/interactive-communication/add-custom-fonts.md)
      ...
      + [在互動式通訊中啟動工作流程](/help/forms/interactive-communication/start-workflow-in-interactive-communication-editor.md)
      + [建立動態表格](/help/forms/interactive-communication/dynamic-table-in-interactive-communication-editor.md)
   + 關聯UI {#associateui}
...
+ 通訊 API {#using-communications}
   ...
   + [AEM Forms通訊API](/help/forms/aem-forms-communication-api-overview.md)
   ...
   + [OAuth伺服器對伺服器驗證](/help/forms/oauth-api-authetication.md)
   + [JWT（JSON Web權杖）伺服器對伺服器驗證](/help/forms/jwt-api-authentication.md)
   ...
   + 開發人員 API 參考 {#aem-forms-developer-api-reference}
      ...
      + [AEM Forms Cloud Service Communications API參考](https://developer.adobe.com/experience-manager-forms-cloud-service-developer-reference/)
      + [AEM Forms Cloud Service JavaScript API參考](https://developer.adobe.com/experience-manager/reference-materials/cloud-service/jsdoc/aem-forms-cloud-service-jsdoc/index.html)
      + [AEM Forms Cloud Service Java API參考](https://javadoc.io/doc/com.adobe.aem/aem-forms-sdk-api/latest/index.html)
...
+ AEM 中的 AI {#ai-in-aem}
   ...
   + MCP支援 {#mcp-support}
      + [搭配AEM as a Cloud Service使用MCP](/help/ai-in-aem/mcp-support/using-mcp-with-aem-as-a-cloud-service.md)
      + 聊天應用程式（網頁與案頭） {#chat-applications}
         + [使用AEM MCP設定Anthropic Claude](/help/ai-in-aem/mcp-support/setup-claude.md)
         + [使用AEM MCP設定OpenAI ChatGPT](/help/ai-in-aem/mcp-support/setup-chatgpt.md)
      + 開發人員工具（IDE擴充功能、案頭應用程式、CLI） {#developer-tools}
         + [使用AEM MCP設定游標](/help/ai-in-aem/mcp-support/setup-cursor.md)
   ...
   + AEM中的代理程式 {#agents}
      ...
      + Brand Experience Agent {#brand-experience}
         + [概觀](/help/ai-in-aem/agents/brand-experience/overview.md)
         ...
         + Experience Modernization Agent {#modernization}
            ...
            + [AEM製作專案快速入門](/help/ai-in-aem/agents/brand-experience/modernization/getting-started-aem-authoring.md)
            + [現代化主控台](/help/ai-in-aem/agents/brand-experience/modernization/console.md)
            + [提示指南](/help/ai-in-aem/agents/brand-experience/modernization/prompting-guide.md)
            + [專案檔案技能](/help/ai-in-aem/agents/brand-experience/modernization/project-documentation.md)
            + [AOE傳送](/help/ai-in-aem/agents/brand-experience/modernization/aoe-delivery.md)
...
+ 實施 {#implementing}
   ...
   + 使用 Cloud Manager {#using-cloud-manager}
      ...
      + [專業測試環境](/help/implementing/cloud-manager/specialized-test-environment.md)
      + 管理您的程式碼 {#managing-code}
         ...
         + [新增外部存放庫](/help/implementing/cloud-manager/managing-code/external-repositories.md)
         + [管理外部存放庫的存取權杖](/help/implementing/cloud-manager/managing-code/manage-access-tokens.md)
   ...
   + 為 AEM as a Cloud Service 開發 {#developing}
      ...
      + [AEM Edge功能](/help/implementing/developing/introduction/edge-functions.md)
      ...
      + 通用編輯器 {#universal-editor}
         ...
         + [事件](/help/implementing/universal-editor/events-universal-editor.md)
         + [篩選器](/help/implementing/universal-editor/filtering.md)
         + [設定 RTE](/help/implementing/universal-editor/configure-rte.md)
         + [設定Assets選擇器](/help/implementing/universal-editor/configure-assets-selector.md)
   ...
   + 開發人員工具 {#developer-tools}
      ...
      + [Web 控制台](/help/implementing/developing/tools/web-console.md)
   ...
   + 內容傳遞概觀 {#content-delivery}
      ...
      + [常見案例的CDN設定片段](/help/implementing/dispatcher/cdn-configuration-snippets-common-scenarios.md)
...
+ 合規性 {#compliance}
   ...
   + HIPAA {#hipaa}
      + [HIPAA整備程度](/help/compliance/hipaa/hipaa-readiness.md)
