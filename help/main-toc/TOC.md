...
+ 發行說明 {#release-notes}
   ...
   + Cloud Manager 發行說明 {#cloud-manager}
      ...
      + 2023 {#2023}
         ...
         + [2023.5.0 版發行說明](/help/implementing/cloud-manager/release-notes/2023/2023-5-0.md)
   ...
   + 最適化表單 {#adaptive-forms-authoring}
      ...
      + 編寫最適化表單 - 核心元件{#authoring-adaptive-forms-core-components}
         + 建立最適化表單{#create-an-adaptive-form-on-forms-cs}
            ...
            + [核心元件中的範例主題、範本和表單資料模型](/help/forms/sample-themes-templates-form-data-models-core-components.md)
