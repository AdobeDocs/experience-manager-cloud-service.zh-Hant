...
+ AEM 中的 AI {#ai-in-aem}
   ...
   + AEM中的代理程式 {#agents}
      ...
      + Brand Experience Agent {#brand-experience}
         ...
         + [開發工作](/help/ai-in-aem/agents/brand-experience/development/development.md)
      + 內容建議程式代理程式 {#content-advisor}
         + [概觀](/help/ai-in-aem/agents/content-advisor/overview.md)
         + [內容探索工作](/help/ai-in-aem/agents/content-advisor/discovery.md)
         + [內容最佳化工作](/help/ai-in-aem/agents/content-advisor/content-optimization.md)
      + 治理代理程式 {#governance}
      ...
      + Experience Modernization Agent {#modernization}
         + [概觀](/help/ai-in-aem/agents/modernization/overview.md)
         + [快速入門](/help/ai-in-aem/agents/modernization/getting-started.md)
         + [現代化主控台](/help/ai-in-aem/agents/modernization/console.md)
   + AI 助理 {#ai-assistant}
