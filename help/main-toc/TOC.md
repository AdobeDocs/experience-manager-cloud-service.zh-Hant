...
+ 資產 {#assets}
   ...
   + 內容片段 {#content-fragments}
      ...
      + [使用 MSM 重複使用資產的內容片段](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/assets/manage/reuse-assets-using-msm.html?lang=zh-Hant)
