...
## Apache和Dispatcher設定與測試 {#apache-and-dispatcher-configuration-and-testing}
...
## Dispatcher設定中支援指令的本機驗證 {#local-validation-of-dispatcher-configuration}
...
## 本機驗證Dispatcher設定語法，以便Apache httpd可以啟動 {#local-validation}
