...
如需Universal Editor UI中可用的擴充功能點完整清單，請參閱Adobe Developer檔案[Universal Editor擴充功能點。](https://developer.adobe.com/uix/docs/services/aem-universal-editor/api/)

## 其他資源 {#additional-resources}

除了UI擴充性之外，通用編輯器還提供其他自訂選項，以實現自訂業務需求的無縫整合。
