...
比較頁面的版本時，使用者想要比較的先前版本會由AEM在背景中重新建立，以方便差異分析。 這是為了能夠呈現內容 [用於並排比較](/help/sites-cloud/authoring/features/page-diff.md).
...
差異會在使用者端透過DOM比較發生，讓差異流程變得簡單，但開發人員需要考慮許多限制。
