...
如果遵循AEM[&#128279;](#spa-development-principles-for-aem)中開發SPA的原則，則您的SPA可運作所有支援的AEM內容製作功能。
...
一般而言，如果您的SPA遵循AEM[&#128279;](#spa-development-principles-for-aem)的SPA開發原則，則您的SPA可在AEM中運作，並可使用AEM SPA編輯器進行編輯。
