---
title: 延伸 [!DNL Adobe Experience Manager] as a Cloud Service使用「Adobe開發人員應用程式產生器」。
description: 延伸 [!DNL Adobe Experience Manager] as a Cloud Service使用「Adobe開發人員應用程式產生器」。
...
# 延伸 [!DNL Adobe Experience Manager] as a Cloud Service使用Adobe開發人員應用程式產生器 {#extend-using-app-builder}
...
自2020年夏季起，企業客戶和合作夥伴都可透過開發人員預覽功能，取得App Builder（舊稱Project Firefly）。 App Builder的正式發行(GA)預計於2021年12月推出。 歡迎開發人員透過我們的 [試用計畫](http://adobe.ly/appbuilder-trial).

>[!NOTE]
>
> 若AEM 6.5客戶想要運用App Builder，請前往 [使用Adobe Experience Manager Developer App Builder擴充Adobe 6.5](https://experienceleague.adobe.com/docs/experience-manager-65/developing/extending-aem/app-builder.html).
