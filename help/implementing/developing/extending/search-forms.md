...
* [搜索和篩選](/help/sites-cloud/authoring/getting-started/search.md#search-and-filter)
...
<table>
 <tbody>
  ...
  <tr>
   <td>全文</td>
   <td>搜索謂詞以進行全文搜索。 它用「jcr:contains´」運算子映射。</td>
   <td>
    <ul>
     <li>預留位置</li>
     <li>屬性名稱</li>
