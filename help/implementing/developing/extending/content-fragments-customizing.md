...
基本 [組成部分](/help/sites-cloud/administering/content-fragments/overview.md#constituent-parts-of-a-content-fragment) 以下是內容片段的：
...
* 所有內容都儲存在 `jcr:content/data` 資產節點：
   ...
   * 每個元素的資料都會以元素名稱之屬性的形式儲存在個別子節點中：例如，元素的內容 `text` 儲存為屬性 `text` 於 `jcr:content/data/master`
...
另請參閱 [內容片段 — 刪除注意事項](/help/sites-cloud/administering/content-fragments/delete-considerations.md).
...
* **內容片段** ([內容片段](https://developer.adobe.com/experience-manager/reference-materials/cloud-service/javadoc/com/adobe/cq/dam/cfm/ContentFragment.html))
   ...
   * **內容元素** ([內容元素](https://developer.adobe.com/experience-manager/reference-materials/cloud-service/javadoc/com/adobe/cq/dam/cfm/ContentElement.html))
...
* `ContentElement` 可調整為：
   ...
   * [`ElementTemplate`](https://developer.adobe.com/experience-manager/reference-materials/cloud-service/javadoc/com/adobe/cq/dam/cfm/ElementTemplate.html)  — 用於存取元素的結構資訊。
