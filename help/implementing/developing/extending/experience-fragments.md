...
[體驗片段](/help/sites-cloud/authoring/fundamentals/experience-fragments.md)是一組或多個元件，包括可在頁面中參考的內容和版面。
...
1. [允許](/help/sites-cloud/authoring/fundamentals/experience-fragments.md#configure-allowed-templates-folder) 的範本掃描可在「體驗片段」主控台中設定。
