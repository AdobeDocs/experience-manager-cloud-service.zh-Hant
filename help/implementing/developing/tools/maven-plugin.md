...
>[!NOTE]
>
>套件建立現在歸 [Apache Jackrabbit FileVault Package Maven增效模組](https://jackrabbit.apache.org/filevault-package-maven-plugin/). 將已建構的套件部署至AEM是由Adobe內容套件Maven外掛程式執行，如此處所述。
