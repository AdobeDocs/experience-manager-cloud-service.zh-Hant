...
# AEM 中的 AI 助理 {#about-ai-assistant-in-aem}

Adobe Experience Manager (AEM)中的AI Assistant提供對話式介面，旨在簡化為AEM相關查詢尋找答案的程式。 它可協助您即時取得與AEM產品相關問題的解答（*可供所有使用者使用*），並自動建立支援票證（*可供支援管理員使用*）。
...
接下來的3分鐘25秒影片將逐步解說AEM中的AI Assistant。
