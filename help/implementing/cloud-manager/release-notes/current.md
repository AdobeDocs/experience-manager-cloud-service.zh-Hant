...
* [Cloud Manager 自訂權限](/help/implementing/cloud-manager/custom-permissions.md)可讓您以可設定的權限建立自訂權限設定檔，以限制 Cloud Manager 使用者對方案、管道和環境的存取。
   ...
   * 如果您希望盡快啟用，請使用與您的 Adobe ID 相關聯的電子郵件地址傳送電子郵件至 `Grp-CloudManager-custom-permissions@adobe.com`。
...
* 對於新建立的 Cloud Manager 計劃，[相關聯的 New Relic 子帳戶](/help/implementing/cloud-manager/user-access-new-relic.md)預設不會啟動。
   ...
   * 如果您希望使用 New Relic 子帳戶，則需要透過 Cloud Manager 選擇使用。
* [已公告並於 10 月版 Cloud Manager 開始](/help/implementing/cloud-manager/release-notes/2023/2023-10-0.md)的[組建環境](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/build-environment-details.md)更新已完成推出。
   * [前端和全端管道](/help/implementing/cloud-manager/configuring-pipelines/introduction-ci-cd-pipelines.md)已新增對 Node 18 的支援。
