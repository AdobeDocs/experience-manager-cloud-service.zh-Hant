...
description: AEM as a Cloud Service中Cloud Manager 2024.5.0的發行說明。
...
* [授權儀表板](/help/implementing/cloud-manager/license-dashboard.md)現在可從左側[側功能表](/help/implementing/cloud-manager/navigation.md)中的不同進入點存取。
