...
為了有機會測試一些即將推出的功能，請加入Adobe的Beta計畫。
...
如果您有興趣測試這項新功能並分享您的回饋意見，請從與您的Adobe ID相關聯的電子郵件地址傳送電子郵件至`aemcs-rum-adopter@adobe.com`。 在您的電子郵件中包含生產、測試和開發環境的網域名稱。  此功能的Beta程式可用性有限。
