...
如果您將Edge Delivery Services授權為Adobe Experience Manager Sites的一部分，[您現在可以直接在Cloud Manager](/help/implementing/cloud-manager/edge-delivery/introduction-to-edge-delivery-services.md)中使用Edge Delivery Services上線網站，並使用引導式自助服務體驗上線。
