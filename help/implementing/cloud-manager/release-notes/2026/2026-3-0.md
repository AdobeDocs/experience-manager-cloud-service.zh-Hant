...
description: 瞭解Adobe Experience Manager as a Cloud Service中的Cloud Manager 2026.3.0版。
...
# Adobe Experience Manager as a Cloud Service中Cloud Manager 2026.3.0的發行說明 {#release-notes}

<!-- https://wiki.corp.adobe.com/display/DMSArchitecture/%5BKT%5D+Cloud+Manager+2025.08.0+Release -->

瞭解關於AEM (Adobe Experience Manager) as a Cloud Service中的Cloud Manager 2026.3.0版。
...
![編輯非生產管道對話方塊，其中顯示兩個「建置策略」選項，即「完整建置」和「智慧型建置」](/help/implementing/cloud-manager/release-notes/assets/non-production-pipeline-edit.png)
