...
description: 瞭解Adobe Experience Manager as a Cloud Service中的Cloud Manager 2026.4.0版。
...
# Adobe Experience Manager as a Cloud Service中Cloud Manager 2026.4.0的發行說明 {#release-notes}

<!-- https://wiki.corp.adobe.com/display/DMSArchitecture/%5BKT%5D+Cloud+Manager+2025.08.0+Release -->

瞭解關於AEM (Adobe Experience Manager) as a Cloud Service中的Cloud Manager 2026.4.0版。
