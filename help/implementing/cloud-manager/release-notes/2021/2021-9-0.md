...
* 現在直接選取計畫卡片會瀏覽至 Cloud Manager **概觀**&#x200B;頁面。看[建立生產計畫](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/programs/creating-production-programs)更多細節。
