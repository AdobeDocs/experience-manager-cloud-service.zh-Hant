...
* 當[憑證](/help/implementing/cloud-manager/managing-ssl-certifications/introduction-to-ssl-certificates.md)到期時，與該憑證關聯的[網域名稱](/help/implementing/cloud-manager/custom-domain-names/introduction.md)和 [IP 允許清單](/help/implementing/cloud-manager/ip-allow-lists/introduction.md)將不再從 CDN 中刪除。在這種情況下，網站仍接受訪客造訪。
