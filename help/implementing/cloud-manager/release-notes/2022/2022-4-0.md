...
AEM as a Cloud Service 中的 Cloud Manager 版本 2022.4.0 發行日期是 2022 年 4 月 7 日。下一個版本計畫於 2022 年 5 月 5 日發行。
...
* 透過在驗證步驟中檢測較舊的 AEM 版本，管道執行現在將更快地失敗。使用者會在 UI 中看到一則提供指引的訊息。
