...
現在，**`Manage Access Tokens`**&#x200B;功能可讓您更有效率地管理權杖。 您可以檢視、重新命名或移除連線至受支援外部Git提供者(包括GitHub Enterprise、GitLab、Bitbucket和Azure DevOps)的Token。
...
1. 在&#x200B;**`Delete Access Token`**&#x200B;對話方塊中，按一下&#x200B;**刪除**&#x200B;以永久移除權杖。
