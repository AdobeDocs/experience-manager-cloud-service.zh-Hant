...
請參閱[建立生產程式](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/creating-production-programs.md)。
   ...
   >[!TIP]
   >
   >如果您想要使用AEM編寫功能與Universal Editor建立新的Edge Delivery網站，而非註冊現有網站，請參閱[按一下即可建立您的第一個Edge Delivery網站](/help/implementing/cloud-manager/edge-delivery/create-edge-delivery-site.md)。 對於使用Edge Delivery傳送的方案，可能不需要發佈層級。 請參閱[彈性發佈階層(Beta)](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/creating-production-programs.md#flexible-publish-tier)。
