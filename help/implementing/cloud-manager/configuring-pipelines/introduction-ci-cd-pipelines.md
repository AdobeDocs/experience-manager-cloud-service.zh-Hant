...
>[!TIP]
>
>如需更多詳細資訊，請參閱[設定非生產管道](/help/implementing/cloud-manager/configuring-pipelines/configuring-production-pipelines.md)。
...
>[!TIP]
>
>如需更多詳細資訊，請參閱[設定非生產管道](/help/implementing/cloud-manager/configuring-pipelines/configuring-non-production-pipelines.md)。
...
* 您必須使用 AEM 版本`2021.12.6151.20211217T120950Z`或更新以使用 Web 層配置管道。
