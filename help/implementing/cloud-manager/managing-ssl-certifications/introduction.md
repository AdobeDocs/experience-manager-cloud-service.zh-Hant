...
當實體向憑證授權單位要求憑證時，CA 會完成驗證計畫。這範圍包含從驗證網域名稱控制到收集公司註冊文件和訂閱協議。實體的資訊獲得驗證後，CA 將使用 CA 的私密金鑰簽署其公開金鑰。由於所有主要的憑證授權單位在 Web 瀏覽器中都有根憑證，因此實體的憑證會透過&#x200B;*信任鏈*&#x200B;連結，且網路瀏覽器會將其識別為受信任的憑證。
