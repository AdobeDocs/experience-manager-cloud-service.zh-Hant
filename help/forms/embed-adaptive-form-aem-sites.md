...
開始使用&#x200B;**[!UICONTROL 最適化Forms — 內嵌(v2)]**&#x200B;內嵌新的最適化表單或現有的最適化表單之前，請新增&#x200B;**最適化Forms使用者端資料庫**&#x200B;至您的AEM Sites頁面：


### 新增Adaptive Forms使用者端資料庫至您的AEM Sites頁面或體驗片段

在&#x200B;**[!UICONTROL 表單容器]**&#x200B;設定對話方塊中選取&#x200B;**[!UICONTROL 當表單涵蓋整個頁面寬度]**&#x200B;選項，並使用最適化Forms時，必須在您對應網站的頁面上包含使用者端資料庫。

![選取表單涵蓋整個頁面寬度選項並使用最適化表單時](/help/forms/assets/overlaycorecomponent.gif)
...
* [建立獨立表單](/help/forms/creating-adaptive-form-core-components.md)
* [直接在AEM Sites頁面中建立表單](/help/forms/create-or-add-an-adaptive-form-to-aem-sites-page.md)
