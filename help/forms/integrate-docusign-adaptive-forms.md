...
AEM Formsas a Cloud Service提供DocuSign](#deploy-custom-submit-action)的[自訂提交動作。 提交動作可協助您使用DocuSign API傳送電子簽章的最適化表單。
...
1. 編譯並[將程式碼部署至您的 [!DNL AEM Forms] as a Cloud Service環境](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/deploying/overview.html?lang=en#customer-releases)。
