...
以Foundation元件[為基礎的](/help/forms/creating-adaptive-form.md)最適化Forms支援各種[現成可用的提交動作](#submit-actions-supported-by-adaptive-forms-based-on-foundation-components)。 當使用者按一下最適化表單上的&#x200B;**[!UICONTROL 提交]**&#x200B;按鈕時，就會觸發提交動作。

## 根據基礎元件提交Forms的動作

以下提交動作受到以基礎元件為基礎的最適化Forms支援：
...
您也可以將根據Foundation元件的最適化表單提交至其他儲存體設定：
...
此外，您可以[自訂預設的提交動作](/help/forms/custom-submit-action-form.md)，以符合特定的組織需求。

### 根據基礎元件設定表單的提交動作

您可以在側邊欄的最適化表單容器屬性的&#x200B;**[!UICONTROL 提交]**&#x200B;區段中設定提交動作。

![AEM Forms提交動作](/help/forms/assets/submit-form-foundation-component.png)
