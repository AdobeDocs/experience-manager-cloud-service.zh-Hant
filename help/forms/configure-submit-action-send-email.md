...
1. 新增電子郵件範本以設定傳送電子郵件提交動作。
   ...
   * 您也可以在&#x200B;**[!UICONTROL 電子郵件範本]**&#x200B;文字方塊中為表單提交新增自訂電子郵件範本。
   ...
   >[!NOTE]
   >
   > 您也可以啟用&#x200B;**[!UICONTROL 使用HTML範本]**，以使用自訂HTML配置而非預設範本來傳送電子郵件。 啟用此選項時，請在&#x200B;**外部範本路徑**&#x200B;欄位中指定HTML檔案。 此功能可透過搶先存取計畫取得。 若要要求存取權，請從您的正式地址傳送電子郵件至[aem-forms-ea@adobe.com](mailto:aem-forms-ea@adobe.com)。
