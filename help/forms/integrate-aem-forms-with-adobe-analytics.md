...
1. 在 **[!UICONTROL Prop]** 區段，將下拉式清單中可用的報表套裝選項，與使用定義的資料元素相對應 [設定資料元素](#configure-data-elements).
   ...
   1. 在 **[!UICONTROL Prop]** 區段，選取報表套裝中可用表單標題的prop，然後選取 ![資料庫圖示](assets/database-icon.svg) 以將其對應至在中建立的表單標題 [設定資料元素](#configure-data-elements).
...
1. 在 **[!UICONTROL 開發]** 區段，選取 ![更多選項](assets/more-options-icon.svg) 然後選取 **[!UICONTROL 核准並Publish至生產環境]**.
...
1. 選取 ![視覺效果](assets/visualization-icon.svg) 並將圖表型別拖放至自由格式區段。 同樣地，您可以將多個圖表型別新增至自由格式區段。
