...
您的AEM環境配置為快取自適應Forms。 它快取所有類型的自適應Forms。 如果您要求在傳遞快取頁之前檢查用戶對頁的訪問權限，請參閱 [快取安全內容](https://experienceleague.adobe.com/docs/experience-manager-dispatcher/using/configuring/permissions-cache.html?lang=zh-Hant)。
