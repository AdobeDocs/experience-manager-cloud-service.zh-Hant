...
1. 在編輯模式中，選取面板，然後選取![cmppr](assets/cmppr.png)。 在側邊欄的[內容]下，啟用&#x200B;**[!UICONTROL 讓面板可重複]**。 指定&#x200B;**[!UICONTROL 最大值]**&#x200B;和&#x200B;**[!UICONTROL 最小值]**&#x200B;欄位的值。
...
可重複子表單類似於最適化Forms中的可重複面板。 在[!DNL AEM Forms] Designer中，執行下列步驟以建立重複的子表單：
...
您可以從XML結構描述以及任何複雜型別元素的minOccours &amp; maxOccurs屬性建立可重複的面板。 如需XML結構描述的詳細資訊，請參閱[使用XML結構描述作為表單模型建立最適化Forms](adaptive-form-xml-schema-form-model.md)。
...
>[!MORELIKETHIS]
>
>* [在最適化表單核心元件中建立具有可重複區段的表單](/help/forms/create-forms-repeatable-sections.md)