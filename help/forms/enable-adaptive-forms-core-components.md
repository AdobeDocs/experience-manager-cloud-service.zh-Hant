---
title: AEM Forms as a Cloud Service上的最適化Forms核心元件
...
# AEM Forms as a Cloud Service上的最適化Forms核心元件{#enable-headless-adaptive-forms-on-aem-forms-cloud-service}
...
所有&#x200B;**AEM Forms as a Cloud Service**&#x200B;環境都包含使用核心元件建立最適化Forms的原生支援。 如需建立表單的逐步指示，請參閱[建立最適化表單](/help/forms/create-an-adaptive-form.md)。

### 為AEM 6.5啟用最適化Forms核心元件
