---
title: AEM Forms as a Cloud Service支援PDF產生的現成可用字型。
description: AEM Forms as a Cloud Service支援記錄檔案和PDF的現成可用字型。
...
# 現成可用(OOTB)支援的字型，適用於Forms as a Cloud Service上的PDF產生  {#ootb-supported-fonts-overview}
...
除了上述字型之外，您也可以使用自訂字型來為PDF提供特定外觀。 若要啟用自訂字型，請使用有效的授權[將自訂字型新增至Forms as a Cloud Service環境](/help/forms/use-custom-fonts.md)。
