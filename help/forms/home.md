...
<div class="version-selector">
  ...
  <ul>
    <li><a href="https://experienceleague.adobe.com/docs/experience-manager-65/forms/home.html?lang=zh-Hant">AEM 6.5 表單文件</a></li>
...
您可以使用該服務來建立和推出互動式和吸引人的數位表單。例如，以一個希望將其客戶註冊流程數位化的組織為例。他們擁有多個包含現有客戶資料的資料來源。他們正在尋求預先填入表單、新增電子簽名表單以及將填寫的表單封存為 PDF 檔案。此外，若組織擁有多種列印表單 (PDF 表單)，他們也會希望將列印表單轉換為數位表單。
...
在大型企業中，表單通常是建立一次並透過複製到內容管理系統來重複使用。維持大型表單資料庫的更新，且讓這些表單易於被發現可能是一項相當大的挑戰。AEM 提供可自訂的表單入口網站，確保客戶透過網頁和行動裝置兩種通道皆能找到並存取其所需的表單。您可以自訂表單入口網站的外觀、品牌化和標誌，滿足您組織的特定需求。

## 提供個人化的通訊

高效率自助服務數位體驗的一個重要組成元件是及時通訊，使用者可以從任何地方在任何裝置上存取個人化的資訊。個人化和及時的通訊可以提高轉換率和使用者滿意度。

使用 AEM Forms，商業使用者可以透過自訂文件範本，並將後端流程中的資訊整合到範本中來建立引人注目的個人化使用者體驗。一組具直覺性的 API 可幫助企業設定規則，這些規則決定何時根據查詢或批次的定期輪詢來產生通訊。


可以輕鬆產生個人化文件，例如收據、歡迎套件和報表。組織可以將流量吸引到個人化的 Web 入口網站，進而讓使用者註冊或購買額外的服務。


## 自動化後台工作流程

使用以表單為中心的工作流程，來自動處理表單資料並將其發送給不同的利益相關者 (例如經理或部門)，以供審查、核准或進一步處理。這些工作流程能協助您的組織盡可能將風險降至最低並保持合規性。其藉由確保表單資料的一致和可稽核處理、自動執行手動任務、提供角色型存取控制，以及協助遵守監管需求而做到這一點。
...
| 功能 | 描述 |
|---|---|
| 最適化表單 | 為您的網站、應用程式和其他數位與實體印刷管道建立和管理互動式、動態、回應式、方便行動裝置使用的資料導向表單： <ul><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/create-an-adaptive-form-on-forms-cs/creating-adaptive-form.html?lang=zh-Hant">建立最適化表單</a></li><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/create-an-adaptive-form-on-forms-cs/themes.html?lang=zh-Hant">建立最適化表單樣式</a></li><li><a href="https://experienceleague.adobe.com/docs/experience-manager-65/forms/adaptive-forms-basic-authoring/create-or-add-an-adaptive-form-to-aem-sites-page.html?lang=zh-Hant">新增最適化表單至 AEM Sites 頁面</a></li></ul> |
...
| 自動化表單轉換服務 | 將舊版 PDF 型表單轉換為可輕鬆於線上管理和分發的最適化表單： <ul><li><a href="https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/configure-service.html?lang=zh-Hant">設定自動表單轉換服務</a></li><li><a href="https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html?lang=zh-Hant">將 PDF 表單轉換為最適化表單</a></li></ul> |
...
| 功能 | 描述 |
|---|---|
| 通訊 API | 隨選或依照預定的時間間隔透過 RESTful API 自動建立、管理及傳遞資料驅動的個人化通訊： <ul><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html?lang=zh-Hant&#document-generation"> 產生個人化通訊 </a> </li><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html?lang=zh-Hant&#document-manipulation"> 組合或分解 PDF 文件</a> </li><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html?lang=zh-Hant&#convert-to-and-validate-pdf%2Fa-compliant-documents">建立符合 PDF/A 標準的文件 </a></li><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html?lang=zh-Hant">使用 DocAssurance API 保護您的文件</a></li></ul> |
| 記錄文件 | 建立並管理已提交表單的記錄，供封存與合規管理使用： <ul><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/generate-document-of-record-for-non-xfa-based-adaptive-forms.html?lang=zh-Hant"> 建立表格記錄以供長期封存</a></li><li>利用伺服器端可擴充性建立自訂功能</li><li>利用記錄文件功能防止篡改封存檔案</li></ul> |
...
| 功能 | 描述 |
|---|---|
| 表單工作流程 | 自動化包含表單和文件服務的商務流程： <ul><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/create-reviews-forms.html?lang=zh-Hant">發送表單或文件以供審核</a></li><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-form-centric-workflows/aem-forms-workflow-step-reference.html?lang=zh-Hant&#assign-task-step">建立核准拒絕工作流程</a></li><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/configure-submit-actions-and-metadata-submission/configuring-submit-actions.html?lang=zh-Hant#enabling-server-side-validation-br"> 將資料提交到資料儲存或工作流程</a></li></ul> |
| 電子簽名 | 與 Adobe Sign 及適用於政府機關的 Adobe Sign 解決方案整合，輕鬆將表單和文件傳送給使用者取得電子簽名： <ul><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/use-adobe-sign/working-with-adobe-sign.html?lang=zh-Hant">使用 Adobe Sign 在最適化表單上進行電子簽名</a></li><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-form-centric-workflows/aem-forms-workflow-step-reference.html?lang=zh-Hant&#generate-document-of-record-step">將記錄文件</a>或<a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-form-centric-workflows/aem-forms-workflow-step-reference.html?lang=zh-Hant&#sign-document-step">電子簽名</a>步驟加入商業工作流程</a></li><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-form-centric-workflows/aem-forms-workflow-step-reference.html?lang=zh-Hant#sign-document-step">使用 Adobe Sign 和 AEM 工作流程對文件進行電子簽名</a></li></ul> |
...
| 功能 | 描述 |
|---|---|
| Forms Analytics | 使用 Adobe Analytics 獲取有關使用者行為和偏好的寶貴見解： <ul><li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/services/enable-adobe-analytics-adaptive-form-using-experience-cloud-setup-automation.html?lang=zh-Hant">使用 Adobe Analytics 連結最適化表單</a></li></ul> |
...
>* [從 AEM 6.5 Forms 移轉至 Cloud Service](/help/forms/migrate-to-forms-as-a-cloud-service.md)
