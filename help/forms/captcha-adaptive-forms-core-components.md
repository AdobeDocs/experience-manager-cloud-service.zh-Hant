...
description: 使用Google reCAPTCHA服務輕鬆增強表單安全性。 裡面有詳細的逐步指南！
...
### 設定 reCAPTCHA Enterprise  {#steps-to-implement-reCAPTCHA-enterprise-in-forms-core-components}
...
## 在自適應表單中使用 Google reCAPTCHA {#using-reCAPTCHA}
