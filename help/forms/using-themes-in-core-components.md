...
>[!NOTE]
>
>如果您的Adaptive Forms內嵌於AEM Sites頁面中，您可以將Adaptive Forms主題內嵌於網站主題中，對網站和表單使用單一主題。 請參閱[在AEM Sites主題中內嵌最適化Forms主題](/help/forms/embed-adaptive-forms-theme-in-site-theme.md)。
