...
AEM Forms as a Cloud Service是Adobe的雲端原生解決方案，用於建立、管理和提供數位表單和通訊。 它可讓組織在整個客戶歷程中，將複雜的交易轉換為簡單的數位體驗。
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <ul>
        ...
        <li><a href="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/using-themes-in-core-components">樣式最適化Forms</a> — 將一致的品牌和視覺設計套用至您的表單</li>
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/sample-themes-templates-form-data-models-core-components.html">使用預先建立的主題和範本</a> — 透過現成的元件加速開發</li>
        ...
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-core-components/create-an-adaptive-form-on-forms-cs/configure-submit-actions-core-components.html">提交動作</a> — 設定使用者提交表單時會發生什麼情況</li>
...
<div class="card">
    ...
    <div class="card-body">
      ...
      <ul>
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-headless-adaptive-forms/using/overview.html">無頭式Forms簡介</a> — 瞭解Headless的表單處理方式</li>
...
<div class="card">
    ...
    <div class="card-body">
      ...
      <ul>
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html?#document-generation">產生個人化通訊</a> — 根據範本和資料建立自訂檔案</li>
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html?#document-manipulation">組合與操控PDF</a> — 組合、分割與修改PDF檔案</li>
        ...
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction.html#flatten-interactive-pdf-documents">平面化互動式PDF</a> — 將互動式欄位轉換為非互動式元素</li>
        ...
        <li><a href="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/using-communications/aem-forms-cloud-service-communications-introduction#convert-pdf-documents-to-pdf-x-standards">新增數位簽章</a> — 以數位簽署檔案以進行驗證</li>
      </ul>
    </div>
  </div>
...
<div class="card">
    ...
    <div class="card-body">
      ...
      <ul>
        ...
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-form-centric-workflows/aem-forms-workflow-step-reference.html?#sign-document-step">將電子簽章新增至工作流程</a> — 在業務流程中包含簽章步驟</li>
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/create-form-centric-workflows/aem-forms-workflow-step-reference.html?#generate-document-of-record-step">簽章的記錄檔案</a> — 產生表單提交的已簽署記錄</li>
      </ul>
    </div>
  </div>
...
<div class="card">
    ...
    <div class="card-body">
      <p>深入瞭解表單使用情形和效能：</p>
      <ul>
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/services/enable-adobe-analytics-adaptive-form-using-experience-cloud-setup-automation.html">啟用Adobe Analytics</a> — 追蹤表單使用情況和效能</li>
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/services/integrate-aem-forms-with-adobe-analytics.html">手動Analytics整合</a> — 設定分析以進行詳細追蹤</li>
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/services/view-understand-aem-forms-analytics-reports.html">檢視Analytics報表</a> — 分析表單效能和使用者行為</li>
      </ul>
    </div>
  </div>
...
<div class="card">
    ...
    <div class="card-body">
      ...
      <ul>
        ...
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/configure-submit-actions-and-metadata-submission/configuring-submit-actions.html#invoke-an-aem-workflow">AEM工作流程</a> — 透過表單提交觸發AEM工作流程</li>
      ...
      <ul>
        ...
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/use-form-data-model/configure-azure-storage.html?lang=zh-Hant">Azure Blob儲存體</a> — 將表單資料儲存在Microsoft的雲端儲存空間</li>
      ...
      <ul>
        ...
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/configure-submit-actions-and-metadata-submission/configuring-submit-actions.html#submit-to-rest-endpoint">RESTful Services</a> — 連線至任何REST API端點</li>
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/use-form-data-model/configure-data-sources.html?lang=zh-Hant">RDBMS資料庫</a> — 連線到關聯式資料庫</li>
        ...
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/configure-submit-actions-and-metadata-submission/configuring-submit-actions.html#send-pdf-via-email">透過電子郵件傳送PDF</a> — 透過電子郵件傳送已提交表單的PDF版本</li>
        <li><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/configure-submit-actions-and-metadata-submission/configuring-submit-actions.html#submit-using-form-data-model">使用表單資料模型提交</a> — 使用表單資料模型提交資料</li>
      </ul>
    </div>
  </div>
</div>
...
<div class="card-container">
  <div class="card">
    ...
    <div class="card-body">
      <ol>
        <li><strong>瞭解基本知識</strong>：瞭解<a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/introduction-forms-authoring.html">最適化Forms</a>，以及它們如何協助將您的業務流程數位化。</li>
        <li><strong>探索範本</strong>：瀏覽<a href="https://experienceleague.adobe.com/docs/experience-manager-core-components/using/adaptive-forms/sample-themes-templates-form-data-models-core-components.html">預先建立的範本和主題</a>，為您的表單專案開一個好頭。</li>
        <li><strong>瞭解表單製作</strong>：依照<a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/create-an-adaptive-form-on-forms-cs/introduction-forms-authoring.html">表單製作指南</a>建立您的第一個表單。</li>
      </ol>
    </div>
  </div>
...
<div class="card">
    ...
    <div class="card-body">
      <ol>
        <li><strong>設定環境</strong>：設定AEM Forms的<a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/setup-configure-migrate/setup-local-development-environment.html">本機開發環境</a>。</li>
        <li><strong>瞭解架構</strong>：瞭解AEM Forms as a Cloud Service的<a href="https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/forms/forms-overview/aem-forms-cloud-service-architecture">架構</a>。</li>
        <li><strong>探索API</strong>：熟悉<a href="https://developer-stage.adobe.com/experience-cloud/experience-manager-apis/api/stable/forms/">個可用的API </a>和SDK，以擴充及整合Forms。</li>
      </ol>
    </div>
  </div>
...
<div class="card">
    ...
    <div class="card-body">
      <ol>
        <li><strong>加入Cloud Service</strong>：依照<a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/setup-configure-migrate/setup-forms-cloud-service.html">加入指南</a>設定AEM Forms as a Cloud Service。</li>
        <li><strong>設定服務</strong>：設定<a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/integrate/services/enable-adobe-analytics-adaptive-form-using-experience-cloud-setup-automation.html">與其他Adobe服務</a>的整合，例如Adobe Analytics。</li>
        <li><strong>從AEM 6.5移轉</strong>：如果您是來自AEM 6.5，請依照<a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/migrate-to-forms-as-a-cloud-service.html">移轉指南</a>操作，移轉到Cloud Service。</li>
      </ol>
    </div>
  </div>
</div>
...
<div class="card">
  ...
  <div class="card-body">
    <p><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/forms-overview/early-access-ea-features">AEM Forms搶先存取計畫</a>在尖端功能正式推出前便提供獨家存取功能，包括：</p>
    <ul>
    ...
    <p>如需搶先存取創新技術的完整清單和詳細檔案，請造訪<a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/forms-overview/early-access-ea-features">AEM Forms搶先存取計畫頁面</a>。</p>
  </div>
</div>

<div class="cta-card">
  <h3>準備好開始使用了嗎？</h3>
  <p><a href="https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/setup-configure-migrate/setup-forms-cloud-service">立即加入AEM Forms as a Cloud Service</a>，並轉換您組織的數位表格體驗。</p>
</div>
