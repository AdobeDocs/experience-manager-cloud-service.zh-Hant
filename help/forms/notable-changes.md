...
* 開發人員在通用[Git存放庫](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/using-cloud-manager/managing-code/cloud-manager-repositories.html)中維護Cloud Service和本機開發環境的程式碼。 根據AEM原型的Git存放庫會在AEM as a Cloud Service程式建立時自動建立。
...
* **自動錶單轉換服務**：此服務未提供自動錶單轉換服務的中繼模型。 您可以[從自動錶單轉換服務檔案](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/extending-the-default-meta-model.html?lang=en#default-meta-model)下載。
