...
您可以編輯範本[的](/help/sites-cloud/authoring/page-editor/templates.md)屬性，其方式與您[編輯頁面屬性的方式非常相同。](/help/sites-cloud/authoring/sites-console/edit-page-properties.md)範本屬性包括：
