...
網站範本通常包含基本網站內容與結構和網站樣式資訊，稱為 [網站主題，](site-themes.md) 以快速啟動新網站。 管理員選取網站範本作為網站的基礎 [在場地建立過程中。](create-site.md)

範本可重複使用且可自訂，因此功能強大。 由於您可以在AEM安裝中使用多個範本，因此您可以靈活地建立不同的網站，以滿足各種業務需求。
