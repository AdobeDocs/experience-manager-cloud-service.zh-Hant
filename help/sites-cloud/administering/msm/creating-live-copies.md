...
>
>轉出[時需要處理和解決這類](rollout-conflicts.md)衝突。
...
選取即時副本頁面時，也可從即時副本綜覽[使用](live-copy-overview.md#using-the-live-copy-overview)同步動作。
...
選取即時副本頁面時，也可從即時副本綜覽[使用](live-copy-overview.md#using-the-live-copy-overview)繼續動作。
