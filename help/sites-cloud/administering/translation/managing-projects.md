...
如果已經翻譯的來源頁面必須 [已重新命名或已移動](/help/sites-cloud/authoring/fundamentals/organizing-pages.md#moving-or-renaming-a-page)，在移動後再次翻譯頁面時，會根據新的頁面名稱/位置建立語言副本。 根據先前名稱/位置的舊語言副本仍會存在。
