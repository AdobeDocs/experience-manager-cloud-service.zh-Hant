...
* 已針對`/content/wknd/en/products`頁面及所有子頁面建立翻譯專案，並以法文副本為目標。 由於語言副本不包含`/content/wknd/fr/products`頁面，因此AEM會立即將`/content/wknd/en/products`頁面及所有子頁面複製到法文副本。 這些副本也包含在翻譯專案中。
* 已針對`/content/wknd/en`頁面及所有子頁面建立翻譯專案，並以法文副本為目標。 由於語言副本包含與`/content/wknd/en`頁面對應的頁面（語言根），因此AEM會複製`/content/wknd/en`頁面和所有子頁面，並將其新增至啟動。 這些副本也包含在翻譯專案中。
