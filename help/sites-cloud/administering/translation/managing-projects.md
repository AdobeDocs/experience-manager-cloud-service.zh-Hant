...
如果需要已翻譯的來源頁面 [已重新命名或已移動](/help/sites-cloud/authoring/fundamentals/organizing-pages.md#moving-or-renaming-a-page)，在移動後再次翻譯頁面將根據新頁面名稱/位置建立新的語言副本。 根據先前名稱/位置的舊語言副本仍會存在。
