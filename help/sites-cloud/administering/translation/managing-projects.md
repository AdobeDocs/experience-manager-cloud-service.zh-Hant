...
AEM中的翻譯專案使用標準 [AEM專案主控台](/help/sites-cloud/authoring/projects/overview.md). 如果您不熟悉AEM專案，請查閱該檔案。
...
手動建立翻譯專案時，除了提供下列翻譯相關屬性的值外，您還必須提供 [基本屬性](/help/sites-cloud/authoring/projects/managing.md#creating-a-project)：
...
翻譯專案的翻譯工作拼貼提供翻譯工作的狀態，以及工作中的頁面和資產數量。
