...
>* 為 [使用內容片段與GraphQL進行無頭內容傳遞](/help/sites-cloud/administering/content-fragments/content-fragments-graphql.md)。
...
「內容片段」控制台提供對片段和相關任務的直接訪問。 有關詳細資訊，請參閱：

* [內容片段控制台的基本結構及處理](/help/sites-cloud/administering/content-fragments/content-fragments-console.md#basic-structure-handling-content-fragments-console)

* [提供的有關內容片段的資訊](/help/sites-cloud/administering/content-fragments/content-fragments-console.md#information-content-fragments)

* [內容片段控制台中內容片段的操作](/help/sites-cloud/administering/content-fragments/content-fragments-console.md#actions-selected-content-fragment)

* [自定義「內容片段」控制台中的可用列](/help/sites-cloud/administering/content-fragments/content-fragments-console.md#select-available-columns)

* [在內容片段控制台中搜索和篩選](/help/sites-cloud/administering/content-fragments/content-fragments-console.md#filtering-fragments)
...
* 從 **發佈** 的子菜單。 [內容片段控制台](/help/sites-cloud/administering/content-fragments/content-fragments-console.md#actions-selected-content-fragment)
   * **現在**  — 經確認後，將立即發佈碎片
   * **計畫**  — 您可以選擇片段的發佈日期和時間
...
可從 **引用** 列 [內容片段控制台](/help/sites-cloud/administering/content-fragments/content-fragments-console.md#information-content-fragments)。

## 查找片段的語言副本 {#language-copies-fragment}

可從以下站點訪問語言副本的詳細資訊： **語言** 列 [內容片段控制台](/help/sites-cloud/administering/content-fragments/content-fragments-console.md#information-content-fragments)。
