...
* 使用內容片段：
   ...
   * [與GraphQL一起，無頭地向您的應用程式交付](/help/sites-cloud/administering/content-fragments/content-fragments-graphql.md)。
...
* 使用 [AEMGraphQL](/help/headless/graphql-api/content-fragments.md)。
