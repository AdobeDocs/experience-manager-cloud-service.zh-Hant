---
title: 變化 - 編寫片段內容
description: 瞭解變體如何允許您為片段建立內容，然後根據用途建立該內容的變體。 這為無頭遞送和頁面創作提供了更大的靈活性。
...
[變體](/help/sites-cloud/administering/content-fragments/content-fragments.md#constituent-parts-of-a-content-fragment) 是內容片段的重要功AEM能，因為它們允許您建立和編輯主內容的副本以用於特定頻道和/或場景，從而使頁面創作和無頭內容交付更加靈活。
...
>[!NOTE]
>
>有關完整資訊，請參閱 [馬爾克當](/help/sites-cloud/administering/content-fragments/content-fragments-markdown.md) 文檔。
...
* 可以在中查看和刪除 [時間軸](/help/sites-cloud/administering/content-fragments/content-fragments-managing.md#timeline-for-content-fragments) 的子菜單。
...
>[!NOTE]
有多種方法可添加 [影像](/help/sites-cloud/administering/content-fragments/content-fragments.md#fragments-with-visual-assets) 到片段和/或頁面。
