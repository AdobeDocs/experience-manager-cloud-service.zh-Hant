...
* **變數**
   ...
   * 片段文字的轉譯是編輯目的所特有的；可以與頻道相關，但這不是強制性的；也可用於臨時本機修改。
...
* **內容片段模型**
   ...
   * 使用組態瀏覽器[啟用](/help/sites-cloud/administering/content-fragments/setup.md)。
   * 是[使用內容片段主控台](/help/sites-cloud/administering/content-fragments/managing-content-fragment-models.md#creating-a-content-fragment-model)建立。
