...
AEM相關內容功能提供連線，讓資產新增至內容頁面時，可供選擇性與片段搭配使用，方法為 [提供在頁面上使用內容片段時可存取的資產範圍，](/help/sites-cloud/authoring/fundamentals/content-fragments.md#using-associated-content) 同時有助於縮短搜尋適當資產所需的時間。 這也為無頭式內容傳送提供彈性。
