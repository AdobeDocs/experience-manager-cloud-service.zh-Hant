...
[AEM GraphQL API](#aem-graphql-api)可讓您對您的[內容片段](/help/sites-cloud/administering/content-fragments/overview.md)執行（複雜）查詢；每個查詢都根據特定的模型型別。 然後，您的應用程式可以使用傳回的內容。
...
用於GraphQL的![內容片段](assets/cf-contentdelivery-cf-use-with-graphql.png "用於GraphQL的內容片段")
...
這[個內容片段模型](/help/sites-cloud/administering/content-fragments/content-fragment-models.md)：
