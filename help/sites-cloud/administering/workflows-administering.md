...
管理工作流程時可使用多種主控台。 使用 [全局導航](/help/sites-cloud/authoring/getting-started/basic-handling.md#global-navigation) 開啟 **工具** 窗格，然後選擇 **工作流程**:
...
若要設定服務，您可以設定OSGi組態檔，請參閱 [OSGi組態檔](/help/implementing/deploying/configuring-osgi.md). 下表說明了任何一種方法所需的屬性。
...
您可以設定收件匣的最大大小，方法是設定 **AdobeGranite工作流程服務**，請參閱 [將OSGi設定新增至存放庫](/help/implementing/deploying/configuring-osgi.md). 下表說明了您配置的屬性。
