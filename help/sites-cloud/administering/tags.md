...
1. 若要建立新的命名空間，請開啟[標記主控台](#tagging-console)，然後點選或按一下工具列中的「**建立**」按鈕，接著&#x200B;**建立命名空間**。
...
1. 若要建立新標記，請開啟[標記主控台。](#tagging-console)
...
* 如果您在未選取命名空間或其他標記的情況下建立標記，則您實際上建立了新的命名空間。

### 發佈標記 {#publishing-tags}

正如在 AEM 中建立任何其他內容一樣，建立標記 (或命名空間) 後，它只會存在於編寫環境中。為了讓您的標記可供使用者使用，您必須發佈標記。
