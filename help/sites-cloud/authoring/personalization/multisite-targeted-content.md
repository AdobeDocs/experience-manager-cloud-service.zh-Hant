...
行銷人員想要將這些變更轉出至歐洲區域，並透過點選或按一下「[轉出頁面](/help/sites-cloud/administering/msm/creating-live-copies.md)」來轉出&#x200B;**即時副本**。 重新整理標籤後，Great Britain網站會有新影像，因為Europe區域繼承自主區域（轉出後）。
...
>[!NOTE]
>
>當您選取品牌名稱&#x200B;**直到**&#x200B;您建立其他區域時，預設會收合名為「主版區域」的預設區域。 然後，當您在「活動」或「產品建議」控制台中選 **取品牌** 時，您會看到「 **區域**&#x200B;**&#x200B;** 」控制台。
