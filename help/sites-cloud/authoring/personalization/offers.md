...
使用選件主控台來建立可在活動體驗](/help/sites-cloud/authoring/personalization/targeted-content.md)中使用的選件。 [當數個體驗需要相同的選件時，在選件主控台中建立選件可節省時間：
...
使用選件控制台建立品牌時，該品牌也會顯示在[活動控制台](/help/sites-cloud/authoring/personalization/activities.md)中，您可在其中新增及管理該品牌的活動。
