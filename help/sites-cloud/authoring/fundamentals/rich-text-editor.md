...
按一下選取文字型元件以顯示[元件工具列](/help/sites-cloud/authoring/fundamentals/editing-content.md#component-toolbar)。
...
對於文字型元件，請從[工具列](/help/sites-cloud/authoring/fundamentals/editing-content.md#component-toolbar)按一下全熒幕模式![RTE全熒幕按鈕](/help/sites-cloud/authoring/assets/editing-full-screen.png)以開啟RTF編輯器，並隱藏頁面內容的其餘部分。
