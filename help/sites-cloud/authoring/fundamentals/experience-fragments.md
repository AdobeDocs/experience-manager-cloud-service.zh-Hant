...
1. 從[元件瀏覽器](/help/sites-cloud/authoring/fundamentals/environment-tools.md#components-browser)拖放必要的元件。
...
發佈您的體驗片段基本上與[發佈頁面](/help/sites-cloud/authoring/fundamentals/publishing-pages.md)相同（從體驗片段主控台或編輯器中進行）。

或者，您也可以[發佈到預覽](/help/sites-cloud/authoring/fundamentals/previewing-content.md) （再次從體驗片段控制檯或編輯器中發佈）。
