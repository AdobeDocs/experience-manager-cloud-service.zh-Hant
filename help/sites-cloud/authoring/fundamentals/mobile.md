...
Adobe Experience Manager頁面是以回應式版面為基礎。 [回應](/help/sites-cloud/authoring/features/responsive-layout.md) 式版面會自動調整您的內容以符合目標裝置，而不需要為特定裝置製作內容。
...
1. 編輯內容頁面。
1. 按一下頁面頂端的&#x200B;**Emulator**&#x200B;圖示，切換至所需的模擬器。

   ![模擬器圖示](/help/sites-cloud/authoring/assets/emulator.png)

1. 將元件從元件瀏覽器或資產瀏覽器拖放至頁面。
1. [根據選取](/help/sites-cloud/authoring/features/responsive-layout.md) 的裝置修改頁面及其元件的回應式版面。
