...
Adobe Experience Manager頁面是以回應式版面為基礎。 [回應式佈局](/help/sites-cloud/authoring/features/responsive-layout.md)會自動調整內容以符合目標裝置，而不需要為特定裝置編寫內容。
...
1. 根據選取的裝置[修改頁面及其元件的回應式配置](/help/sites-cloud/authoring/features/responsive-layout.md)。
