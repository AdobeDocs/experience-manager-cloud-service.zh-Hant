...
AEM隨附多種現成可用的元件，可為網站作者提供全方位功能。 在[編輯頁面](/help/sites-cloud/authoring/fundamentals/editing-content.md)時，這些元件可供使用，而且會依主要功能區域（稱為元件群組）分組，以協助篩選。
...
當[編輯頁面](/help/sites-cloud/authoring/fundamentals/editing-content.md)時，元件可在頁面編輯器側面板的&#x200B;**元件**&#x200B;索引標籤上使用。
...
如需新增元件至頁面的詳細資訊，請參閱[編輯頁面內容](/help/sites-cloud/authoring/fundamentals/editing-content.md)。

## 所有元件概觀 {#overview-of-all-components}

[元件主控台](/help/sites-cloud/authoring/features/components-console.md)提供AEM安裝所提供之元件群組和元件的概觀。 您可以檢視有關個別元件及其使用方式的重要資訊。
...
如果您的頁面是以建議的、最新的可編輯範本為基礎，您可以[編輯範本](/help/sites-cloud/authoring/features/templates.md)啟用/停用這些專案，以及編輯特定元件的引數。
