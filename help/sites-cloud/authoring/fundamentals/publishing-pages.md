...
1. 「管 **理出版物** 」嚮導將啟動。第一步&#x200B;**Options**&#x200B;允許您：
   ...
   * 選擇立即或稍後執行該操作。
   ...
   如果您稍後要取消發佈/取消發佈，請前往「工作流程控制台」以終止對應的工作流程。<!--If you want to cancel a publish/unpublish later, go to the [Workflow Console](/help/sites-administering/workflows.md) to terminate the corresponding workflow.-->
...
1. 在&#x200B;**包含子項**&#x200B;對話框中，取消檢查選項：
   ...
   * 僅包含已發佈的頁面
   ...
   ![取消發佈時包括子代](/help/sites-cloud/authoring/assets/publishing-tree-children.png)
