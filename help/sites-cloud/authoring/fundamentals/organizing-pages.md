...
下面顯示了 [WKND教程](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/overview.html?lang=zh-Hant) 地點，那裡有一篇關於滑板的文章( `la-skateparks`)。
...
>
>還要記住，某些瀏覽器（例如，舊版本的IE）只能接受長度達到一定長度的URL，因此，還有技術原因需要縮短頁面名稱。
...
元件是提供的元AEM素，以便您可以添加特定類型的內容。 AEM附帶一系列提供全面功能的現成元件。 這些類別包括：
