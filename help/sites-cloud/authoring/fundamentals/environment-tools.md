...
對於適當的資源(例如， **站點** 控制台或來自 **資產** 控制台) [時間線可用於顯示任何選定項上的最近活動](/help/sites-cloud/authoring/getting-started/basic-handling.md#timeline)。
...
>* 有 [鍵盤快捷鍵](/help/sites-cloud/authoring/getting-started/keyboard-shortcuts.md) ( `Ctrl-Shift-M`)在 **預覽** 和當前選定模式(例如， **編輯**。 **佈局**&#x200B;等)。
>
