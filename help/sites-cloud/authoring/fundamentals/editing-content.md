...
使用可拖曳至頁面的[元件](/help/sites-cloud/authoring/features/components-console.md)（適合內容類型）新增內容。 然後，您就可以就地編輯、移動或刪除這些項目。
...
>[!NOTE]
>
>如果您的頁面和／或範本已正確設定，則可在編輯時使用[回應式版面](/help/sites-cloud/authoring/features/responsive-layout.md)。
...
* **切換側面板**
   ...
   這會開啟／關閉側面板，其中包含[Asset Browser](/help/sites-cloud/authoring/fundamentals/environment-tools.md#assets-browser)、[Component Browser](/help/sites-cloud/authoring/fundamentals/environment-tools.md#components-browser)和[Content Tree](/help/sites-cloud/authoring/fundamentals/environment-tools.md#content-tree)。

   ![側面板切換](/help/sites-cloud/authoring/assets/side-panel-toggle.png)

* **頁面資訊**

   提供對[頁面資訊](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-information)功能表的存取，包括頁面詳細資料和可在頁面上執行的動作，包括檢視和編輯頁面資訊、檢視頁面屬性，以及發佈／取消發佈頁面。

   ![「頁面資訊」按鈕](/help/sites-cloud/authoring/assets/page-information-icon.png)

* **模擬器**

   切換[模擬器工具列](/help/sites-cloud/authoring/features/responsive-layout.md#selecting-a-device-to-emulate)，該工具列用於模擬另一台設備上頁面的外觀和感覺。 這會在版面模式中自動切換。
...
* **模式選擇器**
   ...
   顯示目前的[模式](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)，並允許您選擇其他模式，例如編輯、版面、時間彎曲或定位。
...
* **注釋**
   ...
   允許您在查看頁面時將[annotations](/help/sites-cloud/authoring/fundamentals/annotations.md)添加到頁面。 在第一個注釋之後，表徵圖將切換到一個數字，指示頁面上的注釋數。

   ![「注釋」按鈕](/help/sites-cloud/authoring/assets/annotations.png)

### 狀態通知{#status-notification}

如果頁面是[工作流程](/help/sites-cloud/authoring/workflows/overview.md)或多個工作流程的一部分，則編輯頁面時，此資訊會顯示在畫面頂端的通知列中。
...
通知會列出針對頁面執行的工作流程。 如果用戶參與當前工作流步驟，則[的選項會影響工作流狀態](/help/sites-cloud/authoring/workflows/participating.md)並獲取有關工作流的詳細資訊，例如：
...
您可以使用[元件瀏覽器](/help/sites-cloud/authoring/fundamentals/environment-tools.md#components-browser)新增元件。 [元件預留位置](#component-placeholder)會顯示元件的位置：

1. 請確定您的頁面處於&#x200B;[**編輯**&#x200B;模式](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)。
...
1. 所選元件將添加到頁面底部。 [根](#edit-content) 據需要編輯元件。
...
* **編輯**
   ...
   [根據元件類](/help/sites-cloud/authoring/fundamentals/components.md) 型，這可讓您 [編輯元件的內容](#edit-content)。通常會提供工具列。

   ![編輯按鈕](/help/sites-cloud/authoring/assets/editing-component-toolbar-edit.png)

* **設定**

   [根據元件類](/help/sites-cloud/authoring/fundamentals/components.md) 型，這可讓您編輯和設定元件的屬性。通常會開啟對話方塊。
...
* **插入元件**
   ...
   這會開啟對話方塊，以新增[元件](/help/sites-cloud/authoring/fundamentals/editing-content.md#inserting-a-component-from-the-paragraph-system)。
...
* **配置**
   ...
   這可讓您修改所選元件的[layout](/help/sites-cloud/authoring/fundamentals/editing-content.md#edit-component-layout)。 這僅適用於選取的元件，而不會為整個頁面啟動[版面模式](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)。
...
1. 選取「版面」動作後：
   ...
   * 元件工具列上會顯示版面動作，而非標準編輯動作。
   ...
   您現在可以像在[layout mode](/help/sites-cloud/authoring/features/responsive-layout.md#defining-layouts-layout-mode)中一樣修改元件的版面。
...
>
>如果您需要編輯頁面的整體版面配置，並影響多個元件，請切換至[版面配置模式](/help/sites-cloud/authoring/features/responsive-layout.md)。
...
[「即時拷貝狀態」頁模式](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)允許您快速概述即時拷貝狀態以及哪些元件是／不是繼承的：
...
[注](/help/sites-cloud/authoring/fundamentals/annotations.md) 意：審核者和其他作者可提供您內容的意見回應。它們通常用於審閱和驗證目的。
...
>* 使用[鍵盤快速鍵](/help/sites-cloud/authoring/getting-started/keyboard-shortcuts.md) `Ctrl-Shift-M`在預覽和上次選擇的模式之間切換。
...
編輯內容時，您可使用預覽[mode](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)預覽頁面。 此模式：
...
* **Sitesconsole** 
   ...
   1. 選擇具有[選擇模式](/help/sites-cloud/authoring/getting-started/basic-handling.md#viewing-and-selecting-resources)的頁面。
   1. 選擇鎖定表徵圖。
...
* 最多可還原20個編輯動作（預設設定）。
* 此外，還可使用[鍵盤快速鍵](/help/sites-cloud/authoring/getting-started/keyboard-shortcuts.md)來還原和重做。
