...
| 位置 | 捷徑 | 說明 |
|---|---|---|
| 任何編輯視窗模式 | `Ctrl-Shift-m` | 切換於 **預覽** 以及目前選取的 [模式](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)</a> (例如， **編輯**， **版面**、等)* |
...
>[!NOTE]
>
>一旦使用者開始以預覽模式與頁面互動， `Ctrl-Shift-m` 捷徑已不再可用。 使用者必須按一下頂端編輯器列或返回「編輯」模式，捷徑才能再次使用。
