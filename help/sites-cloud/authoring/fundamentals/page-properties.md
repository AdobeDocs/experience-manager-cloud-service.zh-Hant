...
* **標題和標籤**
   ...
   * **標籤**  — 您可以在此處更新選取方塊中的清單，在頁面中新增或移除標籤。
      ...
      * 如需關於標籤的詳細資訊，請參閱 [使用標籤](/help/sites-cloud/authoring/features/tags.md).
...
* **開啟/關閉時間**
   ...
   * **準時**  — 在發佈環境中顯示（轉譯）已發佈頁面的日期和時間。 頁面必須以手動方式或預先設定的自動復寫方式發佈。
      ...
      * 如果已存在 [已發佈（手動）](/help/sites-cloud/authoring/fundamentals/publishing-pages.md) 此頁面會保持隱匿（隱藏）狀態，直到在指定時間才呈現。
