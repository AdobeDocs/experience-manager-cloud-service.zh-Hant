...
1. 選取特定裝置後，您可以：
   ...
   * 折頁也可視為內容的分頁符（請勿與[斷點](#layout-definitions-device-emulation-and-breakpoints)混淆）。 此畫面會隨即顯示，以方便顯示使用者在捲動前將在裝置上看到的內容。
...
>[!NOTE]
>
>如果尚未可用，則必須為段落系統/頁顯式激活&#x200B;**佈局容器**。<!-- If not already available, the **Layout Container** must be explicitly [activated for a paragraph system/page](/help/sites-administering/configuring-responsive-layout.md).-->
