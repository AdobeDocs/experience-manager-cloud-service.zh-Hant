...
1. 在[選擇模式](/help/sites-cloud/authoring/getting-started/basic-handling.md#viewing-and-selecting-resources)中選擇頁面。
1. 從工具欄中選擇&#x200B;**建立**&#x200B;選項。
1. 將開啟相同的對話方塊。 如有需要，您可以輸入&#x200B;**Label**&#x200B;和&#x200B;**Comment**。
1. 使用&#x200B;**Create**&#x200B;確認新版本。
...
* **從[時間軸](/help/sites-cloud/authoring/getting-started/basic-handling.md#timeline)邊欄還原為此版本**&#x200B;選項

   恢復所選頁面的先前版本。

* **從頂部[操作工具欄](/help/sites-cloud/authoring/getting-started/basic-handling.md#actions-toolbar)還原**&#x200B;選項
...
1. 導覽至所需資料夾，然後選取](/help/sites-cloud/authoring/getting-started/basic-handling.md#viewing-and-selecting-resources)。[

1. 從頂部[操作工具欄](/help/sites-cloud/authoring/getting-started/basic-handling.md#actions-toolbar)中選擇&#x200B;**還原**，然後選擇&#x200B;**還原版本**。
...
1. 從頂部[操作工具欄](/help/sites-cloud/authoring/getting-started/basic-handling.md#actions-toolbar)中選擇&#x200B;**還原**，然後選擇&#x200B;**還原樹**。 將顯示樹的最新版本：
...
1. 選擇&#x200B;**預覽**。 頁面會顯示在新索引標籤中。
   ...
   >
   >如果您在預覽時遇到問題，請查看頁面的[時間軸](/help/sites-cloud/authoring/getting-started/basic-handling.md#timeline)以查看頁面是否已移動。
...
1. 選擇&#x200B;**與當前比較**。 [頁面差異](/help/sites-cloud/authoring/features/page-diff.md)將開啟並顯示差異。
...
時間扭曲是頁面編輯器的[mode](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)。 要啟動它，只需像切換任何其他模式一樣切換它。
...
* **時間扭曲為唯讀**  — 您無法編輯舊版頁面。它僅供檢視。 如果要還原較舊的版本，則必須使用[restore](#revert-to-a-version)手動執行此操作。
