...
1. 瀏覽以顯示您要建立版本的頁面。
1. 在[選取模式](/help/sites-cloud/authoring/getting-started/basic-handling.md#viewing-and-selecting-resources)中選取頁面。
1. 開啟&#x200B;**時間表**&#x200B;邊欄。
...
* **從[時間表](/help/sites-cloud/authoring/getting-started/basic-handling.md#timeline)邊欄還原為此版本**&#x200B;選項

  復原所選頁面的先前版本。

* 從頂端[動作工具列](/help/sites-cloud/authoring/getting-started/basic-handling.md#actions-toolbar)的&#x200B;**還原**&#x200B;選項
...
1. 導覽至[選取](/help/sites-cloud/authoring/getting-started/basic-handling.md#viewing-and-selecting-resources)必要的資料夾。

1. 從頂端[動作工具列](/help/sites-cloud/authoring/getting-started/basic-handling.md#actions-toolbar)選取&#x200B;**還原**，然後選取&#x200B;**還原版本**。
...
1. 選取&#x200B;**還原**，然後從頂端[動作工具列](/help/sites-cloud/authoring/getting-started/basic-handling.md#actions-toolbar)選取&#x200B;**還原樹狀結構**。 隨即顯示樹狀結構的最新版本：
...
1. 選取&#x200B;**預覽**。 頁面會顯示在新的標籤中。
   ...
   >
   >如果您遇到問題，請檢查頁面的[時間表](/help/sites-cloud/authoring/getting-started/basic-handling.md#timeline)，以檢視頁面是否已移動。
...
1. 選取&#x200B;**與目前**&#x200B;比較。 [頁面diff](/help/sites-cloud/authoring/features/page-diff.md)開啟並顯示差異。
...
時間扭曲是頁面編輯器的[模式](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)。 若要啟動，只需像切換任何其他模式一樣切換即可。
