...
1. 導覽以顯示您要建立版本的頁面。
1. 在[選擇模式](/help/sites-cloud/authoring/getting-started/basic-handling.md#viewing-and-selecting-resources)中選擇頁面。
1. 開啟&#x200B;**時間軸**&#x200B;邊欄。
...
1. 在[選擇模式](/help/sites-cloud/authoring/getting-started/basic-handling.md#viewing-and-selecting-resources)中選擇頁面。
1. 從工具欄中選擇&#x200B;**建立**&#x200B;選項。
1. 將會開啟相同的對話方塊。 如果需要，可以輸入&#x200B;**標籤**&#x200B;和&#x200B;**注釋**。
1. 使用&#x200B;**Create**&#x200B;確認新版本。
...
* **從[時間軸](/help/sites-cloud/authoring/getting-started/basic-handling.md#timeline)邊欄回復為此版本**&#x200B;選項

   重新建立舊版選取頁面。

* **操作工具欄](/help/sites-cloud/authoring/getting-started/basic-handling.md#actions-toolbar)頂部的[恢復**&#x200B;選項
...
1. 導覽至[選擇](/help/sites-cloud/authoring/getting-started/basic-handling.md#viewing-and-selecting-resources)所需的資料夾。

1. 從[操作工具欄](/help/sites-cloud/authoring/getting-started/basic-handling.md#actions-toolbar)上選擇&#x200B;**恢復**，然後選擇&#x200B;**恢復版本**。
...
1. 對於特定頁面，請使用&#x200B;**RESTORE TO VERSION**&#x200B;下拉式選取器來選擇該頁面的必要版本。
...
1. 從[操作工具欄](/help/sites-cloud/authoring/getting-started/basic-handling.md#actions-toolbar)上選擇&#x200B;**恢復**，然後選擇&#x200B;**恢復樹**。 將顯示樹的最新版本：

   ![還原樹狀結構](/help/sites-cloud/authoring/assets/versions-restore-tree-01.png)

1. 使用&#x200B;**日期**&#x200B;最新版本的日期和時間選擇器選擇樹的另一個版本——要還原的版本。

1. 根據需要設定標籤&#x200B;**保留的未版本化頁面**:

   * 如果是作用中（選取），則任何非版本化頁面都將保留，且不會受到還原的影響。

   * 如果非活動（未選定），則任何非版本化頁面都將被移除，因為版本化樹中不存在這些頁面。

1. 選擇&#x200B;**Restore**&#x200B;以將樹的選定版本恢復為&#x200B;*當前*&#x200B;版本。
...
1. 選擇&#x200B;**預覽**。 頁面將顯示在新標籤中。
   ...
   >
   >如果您在預覽時遇到問題，請檢查頁面的[時間軸](/help/sites-cloud/authoring/getting-started/basic-handling.md#timeline)，以查看頁面是否已移動。
...
1. 選擇&#x200B;**與當前比較**。 [頁面diff](/help/sites-cloud/authoring/features/page-diff.md)將開啟並顯示差異。
...
>[!NOTE]
>
>[Timewarp也可與「啟動」搭配使用，以預覽未來](/help/sites-cloud/authoring/launches/preview.md)。
...
時間彎曲是頁面編輯器的[mode](/help/sites-cloud/authoring/fundamentals/environment-tools.md#page-modes)。 若要啟動它，只需像切換任何其他模式一樣來切換它。
...
* **時間彎曲為唯讀** -您無法編輯舊版頁面。僅供檢視。 如果要恢復舊版，則必須使用[restore](#revert-to-a-version)手動完成。
