...
在作者環境中建立並檢閱您的內容後，目標為 [使其可在您的公用網站上使用](/help/sites-cloud/authoring/author-publish.md) （您的發佈環境）。
...
取消發佈頁面會將它從您的發佈中移除，或者 [預覽](/help/sites-cloud/authoring/sites-console/previewing-content.md)，因此不再開放給您的讀者使用。
...
>[!NOTE]
>
>頁面存取者： [別名](/help/sites-cloud/authoring/sites-console/page-properties.md#advanced) 無法取消發佈編輯器中的。 編輯器中的發佈選項僅適用於透過實際路徑存取的頁面。
...
1. 「管 **理出版物** 」嚮導將啟動。在第一個步驟中， **選項**，選擇「取消發佈」(Unpublish **)，而非「發佈」(Publish)的預設** 選項 ****。
   ...
   >[!NOTE]
   >如果您擁有 [預覽](/help/sites-cloud/authoring/sites-console/previewing-content.md) 環境您可以選取 **目的地** 在管理發布期間。
...
* 在 [sites console上的資源概觀資訊](/help/sites-cloud/authoring/basic-handling.md#viewing-and-selecting-resources)
...
* 在 [時間表](/help/sites-cloud/authoring/basic-handling.md#timeline)

  ![時間軸檢視中的發佈狀態](/help/sites-cloud/authoring/assets/publishing-status-timeline.png)

* 在 [頁面資訊功能表](/help/sites-cloud/authoring/page-editor/introduction.md#page-information) 編輯頁面時
