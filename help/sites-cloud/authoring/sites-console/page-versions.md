...
* **從[時間表](/help/sites-cloud/authoring/basic-handling.md#timeline)邊欄還原為此版本**&#x200B;選項

  復原所選頁面的先前版本。

* 從頂端[動作工具列](/help/sites-cloud/authoring/basic-handling.md#actions-toolbar)的&#x200B;**還原**&#x200B;選項
...
1. 從頂端[動作工具列](/help/sites-cloud/authoring/basic-handling.md#actions-toolbar)選取&#x200B;**還原**，然後選取&#x200B;**還原版本**。
...
1. 選取&#x200B;**還原**，然後從頂端[動作工具列](/help/sites-cloud/authoring/basic-handling.md#actions-toolbar)選取&#x200B;**還原樹狀結構**。 隨即顯示樹狀結構的最新版本：
