...
對於文字型元件，請從![工具列](/help/sites-cloud/authoring/assets/editing-full-screen.png)按一下全熒幕模式[RTE全熒幕按鈕](/help/sites-cloud/authoring/page-editor/editor-side-panel.md#components-browser)以開啟RTF編輯器，並隱藏頁面內容的其餘部分。
