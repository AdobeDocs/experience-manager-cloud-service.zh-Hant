...
AEM提供各種鍵盤快速鍵。 有些適用於編輯頁面，有些則適用於[使用主控台](/help/sites-cloud/authoring/sites-console/keyboard-shortcuts.md)，有些則適用於[內容片段主控台](/help/sites-cloud/administering/content-fragments/keyboard-shortcuts.md)。
...
| 位置 | 捷徑 | 說明 |
|---|---|---|
| 任何編輯視窗模式 | `Ctrl-Shift-m` | 在&#x200B;**預覽**&#x200B;和目前選取的[模式](/help/sites-cloud/authoring/page-editor/introduction.md#mode-selector)之間切換（例如，**編輯**、**配置**&#x200B;等）* |
| **編輯**&#x200B;模式 | `Ctrl-z` | [復原上次變更](/help/sites-cloud/authoring/page-editor/edit-content.md) |
|  | `Ctrl-y` | [取消復原上次的變更](/help/sites-cloud/authoring/page-editor/edit-content.md#undoing-and-redoing-page-edits) |
|  | `Ctrl-Click` | 選取多個段落 |
|  | `Ctrl-c` | 複製所選段落 |
...
案頭使用者在使用[主控台](/help/sites-cloud/authoring/sites-console/keyboard-shortcuts.md)時，也可以使用各種鍵盤快速鍵，其中一些是[內容片段主控台](/help/sites-cloud/administering/content-fragments/keyboard-shortcuts.md)。
