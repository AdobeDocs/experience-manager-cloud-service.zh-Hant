...
下列捷徑適用於「網站」、「資產」、「使用者」、「群組」、「專案」和「體驗片段」主控台。 也有特定的捷徑 [內容片段主控台](#keyboard-shortcuts-for-the-content-fragments-console).
...
| 主控台 — 欄檢視 | `Shift-Up/Down Arrow` | 向上/向下移動並選取相同層級的頁面清單 |
|  | `Esc` | 將相同層級的頁面清單上移 |
| 主控台 | `?` | 鍵盤快速鍵說明 |
|  | `/` | 叫用 [搜尋](/help/sites-cloud/authoring/getting-started/search.md) |
|  | `Alt+`&lt;`Number`> | 切換哪個 [邊欄選擇器](/help/sites-cloud/authoring/getting-started/basic-handling.md#rail-selector) 檢視選項 |
|  | ``` ` ``` | 隱藏邊欄 |
|  | `e` | 編輯 |
|  | `p` | 屬性 |
|  | `m` | 移動 |
...
按鍵組合會與Windows一起列出 [修飾鍵值](#os-specific-modifier-keys).
...
AEM提供各種鍵盤快速鍵。 有些適用於使用主控台，有些則適用於 [頁面編輯](/help/sites-cloud/authoring/fundamentals/keyboard-shortcuts.md).

## 內容片段控制檯的鍵盤快速鍵 {#keyboard-shortcuts-for-the-content-fragments-console}

有些鍵盤快速鍵適用於 [內容片段主控台](/help/sites-cloud/administering/content-fragments/content-fragments-console-keyboard-shortcuts.md)