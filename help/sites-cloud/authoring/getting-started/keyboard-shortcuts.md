...
|  | `Alt+`&lt;`Number`> | 切換要檢視的[邊欄選擇器](/help/sites-cloud/authoring/getting-started/basic-handling.md#rail-selector)選項 |
|  | ``` ` ``` | 隱藏邊欄 |
|  | `e` | 編輯 |
|  | `p` | 屬性 |
|  | `m` | 移動 |
...
* [說明功能表](/help/sites-cloud/authoring/getting-started/basic-handling.md#accessing-help)
