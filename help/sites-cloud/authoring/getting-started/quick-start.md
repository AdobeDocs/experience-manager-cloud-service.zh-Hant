...
* 重新排序頁面
   ...
   * 這可在「清單檢視」 [中完成](/help/sites-cloud/authoring/getting-started/basic-handling.md#list-view)。 將應用更改並在其他視圖中可見。

### 頁面編寫 {#page-authoring}

* 導覽連結

   * **當您處於「編輯」模式時** ，無法使用 **連結** 。 若要使用連結進行導覽，您需 [要使用下列任一項](/help/sites-cloud/authoring/fundamentals/editing-content.md#previewing-pages) :
...
* 版本不是從頁面編輯器啟動／建立。 現在可從 **Sites** 主控台(透過選取資源的「建立 **」或「** 時間軸 [](/help/sites-cloud/authoring/getting-started/basic-handling.md#timeline) 」)完成。
...
1. 點選／按一下適當頁面，向下導覽樹狀結構。 頁面資源的呈現方式取決於您使用的檢視——卡 [片、清單或欄](/help/sites-cloud/authoring/getting-started/basic-handling.md#viewing-and-selecting-resources):

   ![檢視選擇下拉式清單](/help/sites-cloud/authoring/assets/views.png)

1. 使用標題中的導 [覽路徑標示瀏覽樹狀結構](/help/sites-cloud/authoring/getting-started/basic-handling.md#the-header)，讓您返回選取的位置：
...
要 [建立新頁](/help/sites-cloud/authoring/fundamentals/organizing-pages.md#creating-a-new-page):
...
1. 這會開啟精靈，引導您收集建立新頁面時 [所需的資訊](/help/sites-cloud/authoring/fundamentals/organizing-pages.md#creating-a-new-page)。 請依照螢幕上的指示進行。
...
[您可使用](/help/sites-cloud/authoring/getting-started/basic-handling.md#quick-actions) :
...
1. [使用「編輯（鉛筆）](/help/sites-cloud/authoring/fundamentals/organizing-pages.md#opening-a-page-for-editing) 」圖示開啟您的頁面進行編輯：
   ...
   * [適當資源的快速動作（卡片檢視／僅限案頭）](#quick-actions-card-view-desktop-only) 。
   * 選取頁面時 [的工具列](#selecting-your-page-for-further-action)。

1. 當編輯器開啟時，您可以：

   * [新增元件至您的頁面](/help/sites-cloud/authoring/fundamentals/editing-content.md#inserting-a-component) :
   ...
   * [編輯頁面上現有元件的內容](/help/sites-cloud/authoring/fundamentals/editing-content.md#component-toolbar) :
   ...
   * [複製（並貼上）](/help/sites-cloud/authoring/fundamentals/editing-content.md#component-toolbar) :
   ...
   * [刪除](/help/sites-cloud/authoring/fundamentals/editing-content.md#component-toolbar) a component:
   ...
   * [預覽頁面](/help/sites-cloud/authoring/fundamentals/editing-content.md#preview-mode) （以檢視它在發佈環境中的顯示方式）
...
編輯頁面屬性有兩種（主要） [方法](/help/sites-cloud/authoring/fundamentals/page-properties.md):
...
發佈頁面的主要方 [法有](/help/sites-cloud/authoring/fundamentals/publishing-pages.md) （以及取消發佈）:
...
* 從主控台取消發佈頁面只能透過「管理出版物 **** 」選項完成，此選項只能在工具列上使用 (不能透過快速動作)。
   ...
   如需詳 [細資訊，請參閱](/help/sites-cloud/authoring/fundamentals/publishing-pages.md#unpublishing-pages) 「發佈頁面」。
...
[可在「參考邊欄](/help/sites-cloud/authoring/fundamentals/environment-tools.md#references) 」中快速存取頁面的參考。
...
1. 點選／按一下「時間軸」欄右下方的省略號，以顯示額外的按鈕，包括「另 **存為版本」**。
