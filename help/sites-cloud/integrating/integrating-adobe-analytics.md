...
* 在[Adobe Launch](#analytics-launch)中新增並設定Adobe Analytics作為擴充功能。 如需Adobe Launch的詳細資訊，您可以從[快速入門手冊](https://experienceleague.adobe.com/docs/experience-platform/tags/get-started/quick-start.html)開始。
