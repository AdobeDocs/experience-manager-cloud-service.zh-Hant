...
+ 製作 {#authoring}
   ...
   + 製作基礎知識 {#fundamentals}
      ...
      + [預覽內容](authoring/fundamentals/previewing-content.md)
...
+ 管理{#administering}
   ...
   + 重複使用內容{#reusing-content}
      ...
      + 轉換 {#translation}
         + [翻譯檔案歷程](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites-journey/translation/overview.html)
