...
[作為Brand Experience Agent的一部分，](/help/ai-in-aem/agents/brand-experience/overview.md) Experience Modernization Agent透過快速且順暢的網站移轉和持續演化，釋放Edge Delivery Services的全部價值(包括AEM製作)。
...
針對複雜的移轉或加速的結果，Adobe提供代理成果工程師(AOE)交付模型。 這是一項選用服務，Adobe工程師可代表您操作AI工具。 如需此傳遞模式的詳細資訊，請參閱檔案： [體驗現代化代理程式的傳遞模式。](/help/ai-in-aem/agents/brand-experience/modernization/delivery-model.md)
