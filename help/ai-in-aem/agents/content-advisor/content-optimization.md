...
透過[內容探索代理程式搜尋正確的資產，以使用內容最佳化代理程式。](/help/ai-in-aem/agents/content-advisor/discovery.md)呈現相關影像後，使用者可以直接從搜尋結果為一或多個資產產生最佳化或頻道特定變體。 此工作流程可確保高品質的輸入資料，並持續提供更佳的最佳化結果。 [如需詳細資訊，請參閱完整的可用最佳化清單](https://developer.adobe.com/experience-cloud/experience-manager-apis/api/stable/assets/delivery/?lang=zh-Hant)。
