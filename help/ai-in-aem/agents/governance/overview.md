...
>[!NOTE]
>
>治理代理程式也包含AI支援的品牌原則匯入功能，其使用AI將客戶的現有品牌指引檔案轉換為結構化、可強制執行的原則檢查，以自動治理、驗證和引導符合規範的內容建立。 如需詳細資訊，請參閱[如何匯入品牌原則](/help/ai-in-aem/agents/governance/how-to-import-a-brand-policy.md)。
