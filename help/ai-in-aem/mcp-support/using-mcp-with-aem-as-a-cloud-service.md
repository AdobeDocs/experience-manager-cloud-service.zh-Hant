...
許多Adobe Experience Manager (AEM)團隊現在都在整合式開發環境(IDE)和聊天式應用程式中工作，例如Cursor、ChatGPT、Anthropic Claude和Microsoft Copilot Studio。 這些應用程式支援模型內容通訊協定(MCP)，可讓應用程式以標準化的方式將後端工具公開給大型語言模型(LLM)。
...
![設定ChatGPT — 設定](assets/chatgpt-1.png)

![設定ChatGPT — 應用程式和聯結器 — 進階設定](assets/chatgpt-2.png)

![設定ChatGPT - App &amp; Connectors — 開發人員模式](assets/chatgpt-3.png)

![設定ChatGPT — 應用程式和聯結器 — 建立應用程式](assets/chatgpt-4.png)

![設定ChatGPT — 應用程式和聯結器 — 新應用程式](assets/chatgpt-5.png)

![設定ChatGPT — 應用程式和聯結器 — AEM內容MCP服務](assets/chatgpt-6.png)

![設定ChatGPT — 詢問AEM內容MCP服務](assets/chatgpt-7.png)
...
![設定Claude — 設定](assets/claude-1.png)

![設定Claude — 聯結器](assets/claude-2.png)

![設定Claude — 聯結器 — 新增自訂聯結器](assets/claude-3.png)

![設定Claude — 聯結器 — 連線自訂聯結器](assets/claude-4.png)

![設定Claude — 聯結器 — 設定自訂聯結器](assets/claude-5.png)

![設定Claude — 聯結器 — 自訂聯結器工具許可權](assets/claude-6.png)

![設定Claude — 詢問AEM內容MCP服務](assets/claude-7.png)
...
![設定游標 — 設定](assets/cursor-1.png)

![設定Cursor - Tools &amp; MCP — 新增自訂MCP](assets/cursor-2.png)

![設定游標 — 新增自訂MCP設定](assets/cursor-3.png)

![設定游標 — 連線](assets/cursor-4.png)

![設定游標 — 詢問新服務](assets/cursor-5.png)
...
![設定Copilot — 代理程式](assets/copilot-1.png)

![設定Copilot — 新增工具](assets/copilot-2.png)

![設定Copilot — 新增工具 — 模型內容通訊協定](assets/copilot-3.png)

![設定Copilot — 新增模型內容通訊協定伺服器（預覽）](assets/copilot-4.png)

![設定Copilot — 新增工具 — 建立新連線](assets/copilot-5.png)

![設定Copilot — 新增工具 — 新增並設定](assets/copilot-6.png)

![設定Copilot — 新增工具 — 設定](assets/copilot-7.png)

![設定Copilot — 測試連線](assets/copilot-8.png)

![設定Copilot — 管理連線](assets/copilot-9.png)

![設定Copilot — 測試代理程式](assets/copilot-10.png)
