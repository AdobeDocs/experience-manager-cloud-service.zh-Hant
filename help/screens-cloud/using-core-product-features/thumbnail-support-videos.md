...
1. 導覽至現有的Screens頻道或建立頻道。
   ...
   >[!NOTE]
   >若要瞭解如何建立管道並將內容新增至管道，請參閱[在Screens as a Cloud Service中建立和管理管道](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/screens-as-cloud-service/create-content/creating-channels-screens-cloud.html?lang=zh-Hant)。
