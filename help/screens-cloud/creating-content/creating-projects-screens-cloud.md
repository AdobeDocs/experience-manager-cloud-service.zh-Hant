...
1. 導覽至Screens內容提供者。
   ...
   >[!NOTE]
   >請參閱[使用Screens內容提供者](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/screens-as-cloud-service/configure-screens-cloud/using-screens-content-provider.html?lang=zh-Hant)，瞭解如何存取Screens內容提供者，以建立您的專案。
