...
description: '瞭解有關Adobe Experience Manager as a Cloud Service安全功能的詳細資訊。 '
...
瞭解有關Adobe Experience Manager as a Cloud Service安全功能的詳細資訊。
...
* [同一站點Cookie支援AEMas a Cloud Service](same-site-cookie-support.md)
