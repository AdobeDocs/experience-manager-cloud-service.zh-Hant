...
<tbody>
  ...
  <tr>
    <td>工作流程啟動器</td>
    <td></td>
    <td>從您的程式碼中移除任何觸發OOTB或自訂DAM更新資產工作流程的工作流程啟動器。</br>上傳至AEMas a Cloud Service的所有資產將由資產處理服務處理。 有工作流程後處理OSGi設定，可用來觸發其他自訂處理步驟。</td>
  </tr>
  <tr>
    <td>自訂轉譯步驟</td>
...
* [入門](/help/onboarding/home.md) — 本指南提供如何開始使用Experience Manageras a Cloud Service的摘要，包括如何取得存取權並設定您的團隊