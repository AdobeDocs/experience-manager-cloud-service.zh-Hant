...
* 從Amazon S3和Azure Blob儲存體傳輸資料會產生相關費用。 傳輸成本會與您現有儲存容器中的資料總量相關(無論是否在AEM中參照)。 請參閱 [Amazon S3](https://aws.amazon.com/s3/pricing/) 和 [Azure Blob儲存體](https://azure.microsoft.com/en-us/pricing/details/bandwidth/) 以取得更多詳細資料。
