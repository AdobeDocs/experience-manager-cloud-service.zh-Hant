...
* 對[來源](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/deploying/revision-cleanup.html)存放庫執行[修訂清理](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-16550.html)和&#x200B;**資料存放區一致性檢查**，以便識別潛在問題並降低存放庫大小。
