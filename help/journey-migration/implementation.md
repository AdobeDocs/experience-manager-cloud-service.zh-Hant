...
* 瞭解如何透過下載[AEM as a Cloud Service SDK](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/aem-as-a-cloud-service-sdk.html)來設定本機開發環境
...
* [Repository Modernizer](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/moving/refactoring-tools/repo-modernizer.html)，此工具會將AEM多重模式專案當作輸入，並將其轉換為AEM as a Cloud Service專案
...
建議在所有AEM版本中進行[資料一致性檢查](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/configuring/consistency-check.html)，以確保內容存放庫處於良好的狀態，以啟動移轉活動。
