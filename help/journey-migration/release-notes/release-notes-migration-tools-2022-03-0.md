---
title: AEMas a Cloud Service版本2022.3.0中移轉工具的發行說明
description: AEMas a Cloud Service版本2022.3.0中移轉工具的發行說明
...
# AEMas a Cloud Service版本2022.3.0中移轉工具的發行說明 {#release-notes}

本頁面總覽AEMas a Cloud Service2022.3.0中移轉工具的發行說明。
...
* 能夠偵測和報告外部器設定的使用情況。 在AEMas a Cloud Service外部化器中，設定是由Cloud Manager設定。 因此，必須重構現有的外部器設定以保持相容性。
