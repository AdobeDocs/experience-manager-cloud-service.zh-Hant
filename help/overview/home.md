---
title: Experience Manager as a Cloud Service 快速入門
...
# Experience Manager as a Cloud Service 文件 {#aem-overview-guide}

從這裡開始了解 Experience Manager as a Cloud Service 的運作方式以及該軟體可以為您做哪些事。
...
## 其他 Experience Manager 說明資源 {#other-resources}
