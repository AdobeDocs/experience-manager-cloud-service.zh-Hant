...
>title="AEMas a Cloud Service架構簡介"
>abstract="在此標籤中，您可以檢視AEMas a Cloud Service的新架構，並了解變更。 AEM產生了一個動態架構，其影像數量可變，因此請務必花時間去了解。雲端架構"
...
有三種環境類型可搭配AEMas a Cloud Service:
