...
1. 登入 [!DNL Experience Manager Assets] 作為核准者，並導覽至資產UI。 若要核准資產，請按一下/點選 **[!UICONTROL 通知]** 表徵圖，然後從清單中選擇審閱任務。
...
1. 點選/按一 **[!UICONTROL 下提交]**，然後點選/按一 **[!UICONTROL 下完成]** ，以關閉確認訊息。新任務的通知將發送給批准者。
1. 登入 [!DNL Experience Manager Assets] 作為核准者，並導覽至「資產」主控台。 若要核准資產，請點選/按一下 **[!UICONTROL 通知]** 表徵圖，然後從清單中選擇審閱任務。
1. 在「復 **[!UICONTROL 查任務]** 」頁中，檢查複查任務的詳細資訊，然後點選/按一下「 **[!UICONTROL 複查」]**。
