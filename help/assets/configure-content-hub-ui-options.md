...
在Content Hub![&#128279;](assets/add-filters.png)上設定使用者介面篩選器
...
>[!CAUTION]
>
>建議您仔細選取您標示為可搜尋的欄位。 僅包含使用者可能搜尋的欄位，且有助於傳回有意義的結果。 日期和數字等欄位更適合用於篩選和排序，而不是作為可搜尋的內容。 將太多欄位標示為可搜尋，可能會影響搜尋結果的品質和效能。
