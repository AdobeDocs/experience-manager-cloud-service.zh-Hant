...
當您[以[!DNL Cloud Service]形式將視訊資產](add-assets.md#upload-assets)上傳至[!DNL Adobe Experience Manager]時，系統會處理視訊。 處理完成後，請參閱資產[!UICONTROL 屬性]頁面的[!UICONTROL 基本]標籤。 智慧型標籤會自動新增至[!UICONTROL 智慧型標籤]下的視訊。 資產微服務利用[!DNL Adobe Sensei]建立這些智慧標籤。
