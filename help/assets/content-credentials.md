...
各大品牌均比從前更加關注內容透明度、AI 揭露，以及防止資產被篡改等情況。Adobe的Content Authenticity Initiative (CAI)建立符合[內容來源與真偽聯盟](https://c2pa.org/specifications/specifications/1.1/specs/C2PA_Specification.html#_trust_model) (C2PA)技術標準的工具。 Content Credentials 是一種加密式、防篡改的新型後設資料，可協助檢視者了解內容的譜系，並確保品牌資產的完整性。其中可能包含廣泛的溯源資料，提供關於數位資產歷史記錄的洞察。
