...
### 在Experience Manager as a Cloud Service中核准AEM Assets Content Hub的資產有何用途？ {#approving-assets-content-hub}

核准資產可確保在AEM Assets Content Hub中只能使用最新和核准的版本，以在所有管道和應用程式中保持嚴格的品牌一致性。 此受控程式可簡化品牌經理和行銷人員的資產管理。

### 核准AEM Assets Content Hub的資產需要哪些先決條件？

您必須擁有AEM Assets as a Cloud Service的存取權和寫入許可權，才能編輯資產中繼資料，尤其是資產屬性中的&#x200B;**狀態**&#x200B;欄位。

### 您如何在AEM as a Cloud Service中使用Assets檢視來核准單一資產，以便用於AEM Assets Content Hub？

選取資產，按一下工具列中的&#x200B;**詳細資料**，瀏覽至&#x200B;**基本**&#x200B;標籤，從&#x200B;**狀態**&#x200B;下拉式清單中選擇&#x200B;**已核准**，然後按一下&#x200B;**儲存**。 資產可在AEM Assets Content Hub中使用。

### 能否為AEM Assets Content Hub大量核准資產？若是，如何核准？

可以，資產可以大量核准。 在Assets檢視中，選取多個資產，按一下「大量中繼資料編輯」**&#x200B;**，在「屬性」下的&#x200B;**狀態**&#x200B;欄位中選取&#x200B;**已核准**，然後按一下「**儲存**」。 所有選取的資產都可在AEM Assets Content Hub中使用。
...
### 什麼是AEM Assets檢視中的核准目標欄位，它如何影響資產發佈？
...
### 誰可以存取AEM Assets Content Hub中的已核准資產，以及已有哪些控制項？

屬於AEM Assets Content Hub中相同組織的使用者可以使用核准的資產。 嚴格的控制確保只能存取最新核准的版本，協助維持品牌一致性和安全性。
