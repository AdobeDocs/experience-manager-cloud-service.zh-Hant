...
![上傳檔案和資料夾](assets/upload-files.png)
...
![根據上傳狀態篩選上傳進度](assets/filter-progress.png)
...
![資產是在上傳後的程序，且標題會顯示處理](assets/upload-process.png)
...
![重試失敗的上傳](assets/upload-failed.png)
...
![一次一個管理重複的資產](assets/duplicate-new.png)

*圖：對於預設無法上傳的重複資產，一次一個資產解決問題。*

![管理所有失敗的大量上傳](assets/manage-duplicate.png)
...
* 使用資產或資料夾縮圖上可用的選項。
  ...
  ![資產縮圖上用於管理資產的選項](assets/delete-new.png)
