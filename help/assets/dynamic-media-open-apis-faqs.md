...
您可以測試任何修飾元，修飾元通常無法透過實驗性 API 取得。例如，&lt;/adobe/experimental/advancemodifiers-expires-YYYYMMDD/assets>
按一下此處，了解更多關於如何使用[實驗性 API](https://developer.adobe.com/experience-cloud/experience-manager-apis/guides/how-to/#experimental-apis) 及[完整修飾元清單](https://developer.adobe.com/experience-cloud/experience-manager-apis/)的詳細資訊。
