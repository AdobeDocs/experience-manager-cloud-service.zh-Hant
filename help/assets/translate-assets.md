...
1. 從「資產」控制檯中，選取 **[!UICONTROL 建立]** 並選擇 **[!UICONTROL 資料夾]** 功能表中。
...
1. 在「資產」主控台中，選取您要建立語言副本的主要語言。
1. 選取GlobalNav圖示，然後選擇 **[!UICONTROL 引用]** 以開啟「參考」窗格。
1. 在「參照」窗格中，選取 **[!UICONTROL 語言副本]**. 「語言副本」面板會顯示資產的語言副本。
...
1. 開啟 **[!UICONTROL 引用]** 窗格並選取 **[!UICONTROL 語言副本]** 在 **[!UICONTROL 份數]**.
1. 選取 **[!UICONTROL 建立並翻譯]** 在底部。
1. 從 **[!UICONTROL 目標語言]** 清單中，選取您要建立檔案夾結構的語言。
1. 從 **[!UICONTROL 專案]** 清單，選取 **[!UICONTROL 建立新的翻譯專案]**.
1. 在「專 **[!UICONTROL 案標題]** 」欄位中，輸入專案標題。
1. 選擇於 **[!UICONTROL 建立]**. 來源資料夾中的資產會複製到您在步驟4中所選地區設定的目標資料夾。
...
1. 選取 **[!UICONTROL 語言副本]** 在 **[!UICONTROL 份數]**. 將顯示可用翻譯副本的清單。
1. 選取 **[!UICONTROL 建立並翻譯]** 在底部。
1. 從 **[!UICONTROL 目標語言]** 清單中，選取您要建立檔案夾結構的語言。
...
1. 選取翻譯專案，檢視專案詳細資訊頁面。
1. 選取底部的省略符號 **翻譯工作** 圖磚，以在翻譯工作流程中檢視資產。 翻譯工作清單也會顯示資產中繼資料和標記項目。這些項目表示資產中繼資料和標記也已翻譯。
...
1. 若要開始資產的翻譯，請選取 **[!UICONTROL 翻譯工作]** 並選取 **[!UICONTROL 開始]** 從清單中。 訊息會通知開始翻譯工作。
1. 若要檢視翻譯工作的狀態，請選取「 」底部的省略符號 **[!UICONTROL 翻譯工作]** 圖磚。 <!-- For more details, see [Monitoring the Status of a Translation Job](/help/sites-administering/tc-manage.md#monitoring-the-status-of-a-translation-job). -->
...
1. 開啟 **[!UICONTROL 引用窗格]**，並選取 **[!UICONTROL 語言副本]** 在 **[!UICONTROL 份數]** 以顯示語言副本清單。
...
1. 選取下的來源根資料夾 **[!UICONTROL 語言副本]** 已為其建立語言副本，然後選取 **[!UICONTROL 在資產中顯示]** 以開啟資料夾 [!DNL Assets].
1. 在Assets UI中，選取您已翻譯的資產，然後選取 **[!UICONTROL 編輯]** 圖示以在編輯模式中開啟資產。
1. 編輯資產，然後儲存變更。
1. 執行中的步驟2-14 [新增至現有翻譯專案](#add-to-existing-translation-project) 更新語言副本的程式。
1. 選取底部的省略符號 **[!UICONTROL 翻譯工作]** 圖磚。 從「 」中的資產清單 **[!UICONTROL 翻譯工作]** 頁面上，您可以清楚檢視資產翻譯版本的儲存暫時位置。
1. 選取旁邊的核取方塊 **[!UICONTROL 標題]**.
1. 從工具列中選取 **[!UICONTROL 接受翻譯]** 然後選取 **[!UICONTROL Accept]** 在對話方塊中，以已編輯資產的翻譯版本覆寫目標資料夾中的翻譯資產。

   >[!NOTE]
   >
   >若要啟用翻譯工作流程以更新目標資產，請接受資產和中繼資料。

   選取 **[!UICONTROL 拒絕翻譯]** 在目標地區設定根目錄中保留資產的原始翻譯版本，並拒絕編輯的版本。
...
1. 選擇 **[!UICONTROL 建立]**。目標語言的新結構列在 **[!UICONTROL 語言副本]**.
1. 從清單中選取結構，然後選取 **[!UICONTROL 在資產中顯示]** 以瀏覽至目標語言中的資料夾結構。
...
1. 從工具列中選取 **[!UICONTROL 儲存]**，然後按一下 **[!UICONTROL 確定]** 以關閉對話方塊。轉譯服務會套用至資料夾。

### 套用自訂翻譯聯結器 {#applying-custom-translation-connector}

如果要為要用於翻譯工作流的翻譯服務應用自定義連接器。若要套用自訂聯結器，請先從安裝聯結器 [封裝管理員](/help/implementing/developing/tools/package-manager.md). 然後，從雲端服務主控台設定連接器。在您設定連接器後，「套用轉譯服務」中所述的「雲端服務」標籤中的連接器清 [單中會顯示此連接器](#applying-the-translation-services)。在您應用自定義連接器並運行翻譯工作流後，翻譯項目的「 **[!UICONTROL Translation Summary]** 」 (翻譯摘要) 表徵圖會在heads **[!UICONTROL Provider]** and **[!UICONTROL Method下顯示連接器詳細資訊]**。
...
1. 選取 **[!UICONTROL 立即設定]** 用以開啟 **[!UICONTROL 建立設定]** 對話方塊。
