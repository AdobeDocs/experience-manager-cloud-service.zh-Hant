---
title: 如何將資產折算AEM?
description: 瞭解如何自動化工作流，將資AEM產翻譯成多種語言，包括二進位檔案、元資料和標籤。
contentOwner: AG
...
多語言資產是指使用多種語言的二進位檔案、元資料和標籤的資產。 通常，資產的二進位檔案、元資料和標籤以一種語言存在，然後翻譯成其他語言以用於多語言項目。 Adobe Experience Manager資產允許您自動執行工作流，以轉換資產（包括二進位檔案、元資料和標籤），以生成其他語言的資產，以用於多語言項目。

要實現資AEM產翻譯自動化，您需要將翻譯服務提供商與Experience Manager整合，並建立將資產翻譯成多種語言的項目。 Experience Manager支援人和機器翻譯工作流。

人力資產轉換AEM:已換算資產會退回並導入Experience Manager。 當翻譯提供商與Experience Manager整合時，資產將自動在Experience Manager和翻譯提供商之間發送。

機器資產折算AEM:機器翻譯服務立即翻譯資產的元資料和標籤。
...
## 準備轉換資產 {#prepare-to-translate-assets}
...
1. 按一下/點擊位於 **翻譯作業** 平鋪以在翻譯工作流中查看資產。 翻譯工作清單也會顯示資產中繼資料和標記項目。這些項目表示資產中繼資料和標記也已翻譯。
