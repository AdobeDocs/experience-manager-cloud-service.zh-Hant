...
| 資產類型 | [瀏覽](/help/assets/navigate-view.md) | 複製 | [上傳](/help/assets/add-delete.md) | 建立 | [刪除](/help/assets/add-delete.md#delete-assets) | 詳細資料 | 影像縮放 | [最近檢視的項目](/help/assets/navigate-view.md) |
|-------------------|----------|----------|----------|----------|----------|-------------------|------------|-----------------|
| 點陣圖 | ✓ | ✓ | ✓ | − | ✓ | ✓ | ✓ | ✓ |
| RAW 檔案 | ✓ | ✓ | ✓ | − | ✓ | ✓ | ✓ | ✓ |
| 資料夾 | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | − | − |
...
| 資產類型 | [下載](/help/assets/manage-organize.md#download) | 拖放 | [影像編輯器](/help/assets/edit-images.md) | [搜尋](/help/assets/search.md) | [智慧標記](/help/assets/metadata.md#tags) | [重新命名](/help/assets/manage-organize.md) | [版本](/help/assets/manage-organize.md#versions-of-assets) |
|---------------|----------|---------------|--------------|----------|------------|----------|----------|
| 點陣圖 | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| RAW 檔案 | ✓ | ✓ | − | ✓ | ✓ | ✓ | ✓ | ✓ |
| 資料夾 | ✓ | ✓ | − | ✓ | − | ✓ | ✓ |
...
| 資產類型 | [中繼資料](/help/assets/metadata.md) | [轉譯](/help/assets/add-delete.md#renditions) | [垃圾桶](/help/assets/add-delete.md#delete-assets) | 複製 | 移動 |
|---------------|-------------------|------------|----------|----------|----------|
| 點陣圖 | ✓ | ✓ | ✓ | ✓ | ✓ |
| RAW 檔案 | ✓ | ✓ | ✓ | ✓ | ✓ |
| 資料夾 | ✓ | − | ✓ | ✓ | ✓ |
