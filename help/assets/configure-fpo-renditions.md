...
若要產生新資產的FPO轉譯，請將&#x200B;**[!UICONTROL 處理設定檔]**&#x200B;套用至資料夾屬性中的資料夾。 在資料夾的[內容]頁面中，按一下[資產處理]索引標籤&#x200B;**[!UICONTROL ，選取]** FPO設定檔&#x200B;**[!UICONTROL 做為]**&#x200B;處理設定檔&#x200B;**[!UICONTROL ，然後儲存變更。]**&#x200B;所有上傳至資料夾的新資產都會使用此設定檔進行處理。
