...
要開啟&#x200B;**[!UICONTROL Collections]**&#x200B;控制台：

若要開啟&#x200B;**[!UICONTROL Collections]**，請點選或按一下Experience Manager標誌。 從導覽頁面，前往&#x200B;**[!UICONTROL Assets]** > **[!UICONTROL Collections]**。

## 建立系列{#create-a-collection}

您可以使用[靜態參考](#create-a-collection-with-static-references)或根據[搜尋准則型篩選器](#create-a-smart-collection)建立系列。 您也可以從燈箱建立系列。

### 建立包含靜態參考{#create-a-collection-with-static-references}的系列

您可以建立包含靜態參考的系列，例如具有資產、檔案夾、系列、回轉集和影像集參考的系列。

1. 導覽至&#x200B;**[!UICONTROL Collections]**&#x200B;主控台。
1. 從工具列點選／按一下「建立&#x200B;**[!UICONTROL 」。]**
...
1. 點選/按一 **[!UICONTROL 下「建立]**」，然後點選/按一 **[!UICONTROL 下「確定]** 」以關閉對話方塊。具有指定標題和屬性的系列會在「系列」主控台中開啟。
   ...
   若要新增資產至系列，請導覽至「資產」使用者介面。 如需詳細資訊，請參閱[將資產新增至系列](#add-assets-to-a-collection)。
...
1. 將資產拖曳至&#x200B;**[!UICONTROL Drop in Collection]**&#x200B;區域。 或者，從工具列點選／按一下「至系列」圖示。****
...
1. 指定系列的名稱。 選擇&#x200B;**[!UICONTROL Public]**&#x200B;將具有查看器角色的DAM用戶組添加到智慧系列。
   ...
   >[!NOTE]
   >
   >如果您選擇&#x200B;**[!UICONTROL Public]**，則在建立智慧系列後，具有「所有者」角色的每個人都可以使用該智慧系列。 如果您取消&#x200B;**[!UICONTROL Public]**&#x200B;選項，DAM使用者群組將不再與智慧型系列相關聯。
...
## 將資產新增至系列{#add-assets-to-a-collection}
...
1. 選取資產，然後點選／按一下工具列中的&#x200B;**[!UICONTROL 至系列]**&#x200B;圖示。 或者，您也可以將資產拖曳至「拖曳至Collection ]**」區域。**[!UICONTROL &#x200B;當放置區域變為活動狀態且其標籤更改為&#x200B;**[!UICONTROL 「放置到添加」時，釋放滑鼠按鈕。]**
1. 在&#x200B;**[!UICONTROL 新增至系列]**&#x200B;頁面中，選取您要新增資產的系列。
1. 點選／按一下「新增&#x200B;****」，然後關閉確認訊息。 資產會新增至系列。
...
1. 從&#x200B;**[!UICONTROL 檔案和資料夾]**&#x200B;清單中，選擇&#x200B;**[!UICONTROL 檔案]**。
1. 視需要修改一或多個篩選器。 點選／按一下「編輯智慧型系列」。 ****&#x200B;您也可以編輯智慧型系列的名稱。
1. 點選／按一下&#x200B;**[!UICONTROL 儲存]**。 此時將顯示&#x200B;**[!UICONTROL 編輯智慧集合]**&#x200B;對話框。
1. 點選／按一下「覆寫&#x200B;**[!UICONTROL 」，以編輯的系列取代原始的智慧型系列。]**&#x200B;或者，選擇「另存新檔」以個別儲存已編輯的系列。****
1. 在確認對話方塊中，點選／按一下「儲存&#x200B;****」以完成程式。

## 檢視並編輯系列中繼資料{#view-and-edit-collection-metadata}

系列中繼資料包含系列的相關資料，包括所新增的任何標籤。

1. 從「系列」控制台中，選取系列，然後點選／按一下工具列中的&#x200B;**[!UICONTROL 屬性]**&#x200B;圖示。
1. 在「系列 **[!UICONTROL 中繼資料]** 」頁面中，從「基本」和「進階」標籤檢視系 **[!UICONTROL 列中繼資]** 料 **** 。
1. 視需要修改中繼資料，然後從工具列點選／按一下「儲存並關閉」以儲存變更。****
...
1. 從工具列點選／按一下「儲存並關閉」**[!UICONTROL ，然後關閉確認對話方塊以完成程式。]**
...
「系列」中的「搜尋」功能支援「搜尋系列」[「搜尋系列」](#search-collections)和「搜尋系列」](#search-within-collections)中的資產」。[
...
1. 選取系列，然後點選／按一下工具列中的&#x200B;**[!UICONTROL Settings]**&#x200B;圖示。 或者，從系列縮圖使用&#x200B;**[!UICONTROL Settings]**&#x200B;快速動作。
1. 修改「系列設定」頁面中 **[!UICONTROL 的系列設定]** 。例如，修改系列標題、說明、成員和權限，如「新增系列」中所 [述](#create-a-collection)。
1. 點選／按一下「儲存&#x200B;**[!UICONTROL 」以儲存變更。]**
...
1. 在對話方塊中，點選／按一下&#x200B;**[!UICONTROL Delete]**&#x200B;以確認刪除動作。
   ...
   >[!NOTE]
   >
   >您也可以透過[刪除已儲存的搜尋](#saved-searches)刪除智慧型系列。
...
1. 在工具列中點選／按一下下載圖示。
1. 在&#x200B;**[!UICONTROL 下載]**&#x200B;對話方塊中，點選／按一下&#x200B;**[!UICONTROL 下載]**。 如果您想要下載系列中資產的轉譯，請選取「轉譯」**[!UICONTROL 「轉譯」]**。<!-- Select the **[!UICONTROL Email]** option to send an email notification to the owner of the collection. -->
...
AdobeEnterprise Manager資產可讓您大量編輯許多系列的中繼資料。 使用[!UICONTROL 屬性]頁面對多個系列執行中繼資料變更，例如將中繼資料屬性變更為公用值，或新增或修改標籤。
...
1. 在各種標籤下修改所選系列的中繼資料屬性。
   ...
   >[!NOTE]
   >
   >您為所選系列新增的中繼資料會覆寫這些系列的先前中繼資料，但標籤除外。 您在&#x200B;**[!UICONTROL Tags]**&#x200B;欄位中新增的任何標籤，都會附加至中繼資料中現有的標籤清單。

1. 若要檢視特定系列的中繼資料屬性，請取消在系列清單中選取剩餘的系列。 中繼資料編輯器欄位會填入特定系列的中繼資料。

   >[!NOTE]
   >
   >* 在系列屬性頁面中，您可以取消選取範圍，從系列清單中移除系列。 系列清單預設會選取所有系列。 您移除之系列的中繼資料不會更新。
...
1. 從「系列」控制台中，選取所要的系列或系列群組，然後點選或按一下工具列中的「至系列」****。
...
1. 點選／按一下「**[!UICONTROL 新增]**」。 訊息會確認系列已新增至&#x200B;**[!UICONTROL 選擇目標]**&#x200B;頁面中的目標系列。 關閉訊息以完成程式。
...
儲存的搜尋會在您建立智慧型系列時建立。智慧型系列會自動新增至「已儲 **[!UICONTROL 存的搜尋]** 」清單。系列的「已保存的搜索」查詢將保存在相 `dam:query` 對位置CRXDE的屬性中 `/content/dam/collections/`。您可以儲存的搜尋和清單中顯示的已儲存搜尋沒有限制。

>[!NOTE]
>
>您可以以共用靜態系列的相同方式共用智慧型系列。

編輯已儲存的搜尋與編輯智慧型系列相同。 如需詳細資訊，請參閱[編輯智慧型系列](#edit-a-smart-collection)。
...
## 在系列{#run-a-workflow-on-a-collection}上執行工作流程
