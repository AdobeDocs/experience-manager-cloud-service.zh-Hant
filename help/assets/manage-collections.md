...
1. 將資產拖曳至「集合」中的&#x200B;**[!UICONTROL 拖放]**&#x200B;區域。 或者，點選/按一下工具列中的&#x200B;**[!UICONTROL 至系列]**&#x200B;圖示。
...
1. 指定集合的名稱。 選取&#x200B;**[!UICONTROL Public]** ，將具有檢視器角色的DAM使用者群組新增至智慧型集合。
   ...
   >[!NOTE]
   >
   >如果選擇&#x200B;**[!UICONTROL Public]**，則建立後，具有「所有者」角色的每個人都可以使用智慧集合。 如果您取消&#x200B;**[!UICONTROL Public]**&#x200B;選項，DAM使用者群組將不再與智慧型集合相關聯。
...
1. 選取資產，然後點選/按一下工具列中的&#x200B;**[!UICONTROL 至集合]**&#x200B;圖示。 或者，您也可以將資產拖曳至「集合」中的「**[!UICONTROL 拖放]**」區域。 當拖放區域變為活動狀態且其標籤變為&#x200B;**[!UICONTROL Drop to Add]**&#x200B;時，釋放滑鼠按鈕。
...
1. 在「資產」使用者介面中，點選/按一下工具列中的&#x200B;**[!UICONTROL 搜尋]**&#x200B;圖示。
1. 將游標置於Omnisearch框中，選擇`Enter`鍵。
...
1. 在工具列中，點選/按一下「屬性」]**圖示。**[!UICONTROL 
...
1. 從工具列中，點選/按一下下載圖示。
1. 在&#x200B;**[!UICONTROL 下載]**&#x200B;對話方塊中，點選/按一下&#x200B;**[!UICONTROL 下載]**。 如果您想要下載系列內資產的轉譯，請選取「**[!UICONTROL 轉譯]**」。 <!-- Select the **[!UICONTROL Email]** option to send an email notification to the owner of the collection. -->
...
>[!NOTE]
>
>大量編輯方法適用於集合中的可用資產。 對於可跨資料夾使用或符合通用條件的資產，可以在搜尋](/help/assets/search-assets.md#metadata-updates)後，大量更新中繼資料。[

1. 從集合控制台中，選取您要編輯的集合。
1. 從工具列中，點選/按一下「屬性」**[!UICONTROL 「屬性」]**&#x200B;以開啟所選集合的「屬性」[!UICONTROL 「屬性」]頁面。
1. 修改各種標籤下所選集合的中繼資料屬性。

   >[!NOTE]
   >
   >您為所選集合新增的中繼資料會覆寫這些集合（標籤除外）的先前中繼資料。 您在&#x200B;**[!UICONTROL 標籤]**&#x200B;欄位中新增的任何標籤，都會附加至中繼資料中的現有標籤清單。
...
1. 從「集合」控制台，選擇所需的集合或集合組，然後點選或按一下工具列中的「**[!UICONTROL 至集合]**」。
...
1. 在Omnisearch欄位中使用游標，選擇`Enter`鍵。
