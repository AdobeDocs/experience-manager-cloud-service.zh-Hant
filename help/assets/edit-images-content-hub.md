...
有權存取Adobe Express和AEM Assets Content Hub的使用者，以及有權將資產重新混合成新變體的使用者，可以使用Content Hub編輯影像。

### 如何在AEM Assets Content Hub中使用Adobe Express編輯影像？

若要編輯影像，請按一下影像資產卡上的&#x200B;**[在Adobe Express中開啟]**，或開啟影像的詳細資料，然後按一下Adobe Express標誌。 這會在AEM Assets Content Hub中載入內嵌Adobe Express編輯器，讓您在不離開平台的情況下進行編輯。

### Adobe Express在AEM Assets Content Hub中提供哪些編輯功能？

Adobe Express提供各種影像編輯功能，包括調整影像大小、移除或變更背景顏色、裁切影像，以及將影像與AI產生的影像或文字合併，以及其他功能。

### 在AEM Assets Content Hub中，可以將編輯的影像儲存為哪些檔案格式？

您可以以PNG （高品質）、JPG （適用於小型檔案）或PDF （適用於檔案）格式儲存編輯的影像。

### 在Content Hub中儲存編輯的影像時，應該填寫哪些欄位？

儲存已編輯的影像時，您應該在&#x200B;**另存新檔**&#x200B;欄位中指定資產的名稱，並在&#x200B;**行銷活動名稱**&#x200B;欄位中指定行銷活動名稱。 Adobe也建議在其他欄位中指定值，例如關鍵字、管道、時間範圍和區域，以增強可搜尋性和組織性。

### 是否可以將編輯內容儲存為Content Hub中的新資產？

可以，編輯之後，您可以按一下&#x200B;**另存為新資產**，將變更儲存為Content Hub中的新資產。
