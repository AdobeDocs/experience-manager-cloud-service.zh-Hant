...
您可以在Adobe I/O上建立新的設定，以搭配品牌入口網站來設定AEM資產。
...
* [將資產從AEM Assets發佈至品牌入口網站](publish-to-brand-portal.md#publish-assets-to-bp)
...
* DSTRQ3（請求3）:系統會觸發另一個請求，以發佈資產所在的資料夾，並複製品牌入口網站中的資料夾。
