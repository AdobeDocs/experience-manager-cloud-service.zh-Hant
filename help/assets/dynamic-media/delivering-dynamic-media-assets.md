...
* 如果您的網站未Experience Manager，您可以選擇：
   ...
   * 如果您的網站回應迅速，您可以[傳送最佳化的影像](/help/assets/dynamic-media/responsive-site.md)。

>[!NOTE]
>
>智慧型影像處理可與您現有的影像預設集搭配使用。 它會在傳送的最後毫秒使用智慧，根據瀏覽器或網路連線速度進一步縮小影像檔案大小。 如需詳細資訊，請參閱[智慧影像](/help/assets/dynamic-media/imaging-faq.md)。
...
若要深入了解，請參閱[HTTP/2內容傳送常見問題](/help/assets/dynamic-media/http2faq.md)。
