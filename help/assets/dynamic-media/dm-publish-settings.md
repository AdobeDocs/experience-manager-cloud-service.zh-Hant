...
| **[!UICONTROL 預設要求屬性]** | |
| **[!UICONTROL 預設影像檔案字尾]** | 必要。<br>路徑不包含檔案字尾時，附加至目錄Path和MaskPath欄位值的預設資料檔案副檔名。<br>另請參閱「動態媒體檢視器參考指南」中的[DefaultExt](https://experienceleague.adobe.com/en/docs/dynamic-media-developer-resources/image-serving-api/image-serving-api/attributes/r-defaultext)引數。 |
