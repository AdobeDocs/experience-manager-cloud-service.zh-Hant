...
>[!NOTE]
>
>如需「資產」使用者介面的詳細資訊，請參閱「使用Touch UI[管理資產」，並將其套用至新資料夾，以便上傳您的影像集資產。](/help/assets/manage-digital-assets.md)
...
>
>請參閱[設定動態媒體](/help/assets/dynamic-media/config-dm.md)中的「建立批次集預設集以自動產生影像集和回轉集」。
