...
>[!NOTE]
>
>如需「資產」使用者介面的詳細資訊，請參閱「使用Touch UI](/help/assets/manage-digital-assets.md)管理資產」，並將其套用至新資料夾，以便上傳您的影像集資產。[
...
您可以像[上傳AEM Assets的任何其他資產一樣，上傳回轉集的影像。](/help/assets/manage-digital-assets.md)
