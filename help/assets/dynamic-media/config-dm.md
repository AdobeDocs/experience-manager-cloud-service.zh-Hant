...
1. 連接成功後，可以設定以下項：
   ...
   | 屬性 | 說明 |
   |---|---|
   | 公司 | Dynamic Media帳戶的名稱。 你可以在Dynamic Media有個Experience Manager賬戶。<!-- CQDOC-19579 and CQDOC-19612 --><br>另請參閱 [配置Dynamic Media公司別名帳戶](/help/assets/dynamic-media/dm-alias-account.md)。 |
   | 公司根資料夾路徑 | 您公司的根資料夾路徑。 |
