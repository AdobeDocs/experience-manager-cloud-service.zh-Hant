...
1. 在Experience Manager作為Cloud Service中，點選Experience Manager作為Cloud Service標誌以存取全域導覽主控台。
1. 在主控台的左側，點選「工具」圖示，然後點選「 **[!UICONTROL Cloud Services> Dynamic Media設定]**」。
1. 在「 Dynamic Media設定瀏覽器」頁面的左側窗格中，點選&#x200B;**[!UICONTROL global]**（請勿點選或選取&#x200B;**[!UICONTROL global]**&#x200B;左側的資料夾圖示）。 然後點選「**[!UICONTROL 建立]**」。
...
1. 按一下&#x200B;**[!UICONTROL 連線至Dynamic Media]**。
1. 在&#x200B;**[!UICONTROL 更改密碼]**&#x200B;對話框的&#x200B;**[!UICONTROL 新密碼]**&#x200B;欄位中，輸入包含8到25個字元的新密碼。 密碼必須至少包含以下各項之一：
   ...
   **[!UICONTROL 當前密碼]**&#x200B;欄位有意預填和隱藏於交互中。
   ...
   如有必要，您可以點選密碼眼表徵圖以顯示密碼，檢查您鍵入或重新鍵入的密碼的拼寫。 再次點選圖示以隱藏密碼。

1. 在&#x200B;**[!UICONTROL 重複密碼]**&#x200B;欄位中，重新鍵入新密碼，然後點選&#x200B;**[!UICONTROL 完成]**。

   點選&#x200B;**[!UICONTROL 建立Dynamic Media設定]**&#x200B;頁面右上角的&#x200B;**[!UICONTROL 儲存]**&#x200B;時，會儲存新密碼。

   如果您在&#x200B;**[!UICONTROL 變更密碼]**&#x200B;對話方塊中點選了&#x200B;**[!UICONTROL 取消]**，則在儲存新建立的Dynamic Media組態時，您仍須輸入新密碼。
...
1. 點選&#x200B;**[!UICONTROL 儲存]**。 新Dynamic Media密碼和設定已儲存。 如果您已點選&#x200B;**[!UICONTROL 取消]**，則不會進行密碼更新。
1. 在&#x200B;**[!UICONTROL 設定Dynamic Media]**&#x200B;對話方塊中，點選&#x200B;**[!UICONTROL 確定]**&#x200B;以開始設定。

   >[!IMPORTANT]
   新Dynamic Media設定完成設定時，您會在Experience Manager內收到狀態通知，作為Cloud Service的收件匣。
   此收件匣通知會通知您設定是否成功。
如需詳細資訊，請參閱[疑難排解新Dynamic Media設定](#troubleshoot-dm-config)和[您的收件匣](/help/sites-cloud/authoring/getting-started/inbox.md) 。
...
1. 若要在發佈Dynamic Media內容之前安全地預覽，Experience Manager為Cloud Service預設會使用Token式驗證。 不過，您也可以「允許清單」更多IP，讓使用者存取安全預覽內容。 若要設定此動作，請執行下列動作：<!-- To securely preview Dynamic Media content before it gets published, you must "allowlist" the Experience Manager as a Cloud Service author instance to connect to Dynamic Media. To set up this action, do the following: -->
   ...
   * 在頁面右上角附近的導覽列，點選「**[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL Publish Setup]** > **[!UICONTROL Image Server]**」。
...
1. 在Experience Manager的右上角附近，以Cloud Service頁面的形式點選鈴聲圖示，然後點選&#x200B;**[!UICONTROL View All]**。
1. 在收件匣頁面上，點選成功通知以閱讀設定狀態和記錄的概述。
...
### 更改Dynamic Media {#change-dm-password}的密碼
...
點選&#x200B;**[!UICONTROL 編輯Dynamic Media設定]**&#x200B;頁面右上角的「**[!UICONTROL 儲存]**」時，會儲存已變更的密碼。

1. 在Experience Manager作為Cloud Service中，點選Experience Manager作為Cloud Service標誌以存取全域導覽主控台。
1. 在主控台的左側，點選「工具」圖示，然後點選「 **[!UICONTROL Cloud Services> Dynamic Media設定]**」。
1. 在「 Dynamic Media Configuration Browser（配置瀏覽器）」頁面的左窗格中，點選&#x200B;**[!UICONTROL global]**。請勿點選或選取&#x200B;**[!UICONTROL global]**&#x200B;左側的資料夾圖示。 然後，點選「**[!UICONTROL Edit]**」。
1. 在「**[!UICONTROL 編輯Dynamic Media配置]**」頁的&#x200B;**[!UICONTROL Password]**&#x200B;欄位正下方，點選「**[!UICONTROL Change Password]**」。
1. 在&#x200B;**[!UICONTROL 更改密碼]**&#x200B;對話框中，執行以下操作：
   ...
   * 在&#x200B;**[!UICONTROL 重複密碼]**&#x200B;欄位中，重新鍵入新密碼，然後點選&#x200B;**[!UICONTROL 完成]**。

1. 在&#x200B;**[!UICONTROL 編輯Dynamic Media設定]**&#x200B;頁面的右上角，點選&#x200B;**[!UICONTROL 儲存]**，然後點選&#x200B;**[!UICONTROL 確定]**。
...
若要開啟「應用程式一般設定」頁面，請在Dynamic Media Classic全域導覽列中，按一下「**[!UICONTROL 設定>應用程式設定>一般設定]**」。
...
1. 在作為Experience Manager的Cloud Service中，按一下作為Cloud Service徽標的Experience Manager以訪問全局導航控制台，然後按一下&#x200B;**[!UICONTROL 常規>CRXDE Lite]**。
1. 在左側邊欄中，導覽至下列項目：
...
1. 在CRXDE Lite頁面的右側，下方：
   ...
   * 按兩下&#x200B;**[!UICONTROL jobParam]**&#x200B;以開啟其關聯的文本欄位。 如需指定MIME類型可使用的允許處理參數值清單，請參閱[支援的MIME類型](/help/assets/file-format-support.md)。
...
1. 在&#x200B;**Adobe CQ Scene7資產MIME類型Service**&#x200B;頁面上，按一下任何加號圖示&lt;+>。 在表格中按一下加號以新增新MIME類型的位置很瑣碎。
...
1. 在&#x200B;**[!UICONTROL Properties]**&#x200B;標籤中，在&#x200B;**[!UICONTROL enabled]**&#x200B;行的&#x200B;**[!UICONTROL Value]**&#x200B;列標題下，按兩下值，仍然選擇MIME類型`image_vnd.dwg`。 **[!UICONTROL Value]**&#x200B;下拉清單已開啟。
