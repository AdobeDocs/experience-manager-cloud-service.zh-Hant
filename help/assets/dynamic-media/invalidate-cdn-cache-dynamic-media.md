...
1. 在Adobe Experience Manager as aCloud Service中，前往&#x200B;**[!UICONTROL 工具]** > **[!UICONTROL 資產]** > **[!UICONTROL CDN失效範本]**。
...
1. 以Experience Manager形式Cloud Service，前往&#x200B;**[!UICONTROL 工具]** > **[!UICONTROL 資產]** > **[!UICONTROL CDN失效]**。
...
1. 在&#x200B;**[!UICONTROL CDN失效]** - **[!UICONTROL 確認]**&#x200B;頁面的&#x200B;**[!UICONTROL URL]**&#x200B;清單方塊中，您會看到一或多個從先前建立的CDN失效範本產生的URL清單，以及您剛新增的資產。
   ...
   例如，使用先前步驟中顯示的CDN失效範本範例，假設您新增了名為`spinset`的單一資產。 前往「**[!UICONTROL 工具]** > **[!UICONTROL 資產]** > **[!UICONTROL CDN失效]**」時，會在&#x200B;**[!UICONTROL CDN失效 — 確認]**&#x200B;使用者介面中產生下列五個URL:
...
| *輸入的URL無效。* | 如果&#x200B;**[!UICONTROL CDN失效]** - **[!UICONTROL 確認]**&#x200B;頁面中沒有URL，且您選取&#x200B;**[!UICONTROL 提交]**，則發生。 |
