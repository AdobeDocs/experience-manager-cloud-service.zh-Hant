   ...
   <table>
    <tbody>
      ...
      <td><p><strong>預覽特定轉譯中的資產</strong></p>
        ...
        </ul><p>使用 <strong>+</strong> 和 <strong>-</strong>圖示可分別增加或減少所選影像的縮放。 若要將影像還原為原始縮放，請選取 <strong>重設</strong>.<br>如果您在觸控熒幕上，請點兩下影像以按步驟放大。 當您達到最大縮放時，請再次點兩下影像以重設縮放狀態。 拖移過影像以平移。</p> </td>
      </tr>
      <tr>
      <td>多媒體</td>
      <td>是</td>
