...
您可以選擇已上傳的資產，然後點選&#x200B;**[!UICONTROL Publish]**&#x200B;或&#x200B;**[!UICONTROL Quick Publish]**，以發佈您的動態媒體資產。 發佈動態媒體資產後，您就可透過URL或在頁面上內嵌程式碼，將其加入網頁。

您也可以立即發佈上傳的資產，不需任何使用者干預。 或者，您可以選擇性地發佈這些資產。 請參閱[設定動態媒體。](config-dm.md) 或者，您可以使用檔案夾層級的「選擇性發佈」，選擇性地將資產發佈至互斥的「動態媒體」或「AEM」。 **** 請參閱[在動態媒體中使用選擇性發佈。](/help/assets/dynamic-media/selective-publishing.md)
...
另請參閱[將動態媒體視訊檢視器或影像檢視器內嵌至網頁。](embed-code.md)
...
請參閱[HTTP/2內容傳送常見問題](/help/assets/dynamic-media/http2faq.md)以瞭解更多資訊。
