...
請參閱[動態媒體影像提供與轉譯API說明](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/image-serving-api/image-serving-api/responsive-static-image-library/c-about-responsive-static-image-library.html#about-responsive-image-library)中的&#x200B;*回應式靜態影像庫*，以取得有關如何將回應式檢視器內嵌至網頁的詳細資訊。
