...
1. [預覽混合媒體集](#previewing-mixed-media-sets)。
   ...
   選取「混合媒體集」，即可預覽。 若要檢查所選檢視器中的混合媒體集，請按一下縮圖圖示。 您可以從&#x200B;**[!UICONTROL 檢視器]**&#x200B;選單中選擇不同的檢視器，該選單可從左側導軌下拉式選單中取得。
...
1. 若要選取您要納入混合媒體集的資產，請點選「資產選取器」。 選擇它們，然後按一下&#x200B;**[!UICONTROL 選擇]**。
...
1. 在混合媒體集編輯器中，執行下列任一操作：
   ...
   * 若要依資產名稱的遞增或遞減順序排序，請在左側面板中，點選&#x200B;**[!UICONTROL Assets]**（圖片圖示）。 在&#x200B;**[!UICONTROL Assets]**&#x200B;標題的右側，點選向上或向下插入符號圖示。
      ...
      >[!NOTE]
      >
      >* 若要刪除整個混合媒體集，請從任何檢視模式（例如&#x200B;**[!UICONTROL 卡片檢視]**&#x200B;或&#x200B;**[!UICONTROL 欄檢視]**）導覽至混合媒體集。 將游標暫留在資產上，然後點選核取標籤圖示，以便選取資產。 在鍵盤上按&#x200B;**[!UICONTROL Backspace]**，或在工具列上按一下&#x200B;**[!UICONTROL More]**（三個點），然後點選&#x200B;**[!UICONTROL Delete]**。
         >
         >
      * 您可以導覽至混合媒體集，編輯資產。 在左側導軌中，點選「**[!UICONTROL 設定成員]**」，然後點選個別資產上的「**[!UICONTROL 鉛筆]**」圖示以開啟編輯視窗。
...
1. 完成編輯時，點選「**[!UICONTROL 儲存]**」。
   ...
   >[!NOTE]
   >
   >* 若要編輯混合媒體集中的資產 — 導覽至混合媒體集。 點選（不要選取）集，以便在「Experience Manager集預覽」頁面中開啟它。 在左側導軌中，按一下向下插入符號以開啟下拉式清單，然後點選&#x200B;**[!UICONTROL 設定成員]**。 在「設定成員」頁面中，暫留在資產上，然後點選&#x200B;**[!UICONTROL Edit]**（鉛筆圖示）以開啟編輯頁面。
      >
      >
   * 若要刪除整個混合媒體集 — 從任何檢視模式（例如卡片檢視或欄檢視），導覽至混合媒體集。 暫留在集上，然後點選&#x200B;**[!UICONTROL 選取]**（勾選圖示）。 在鍵盤上按&#x200B;**[!UICONTROL Backspace]**，或點選&#x200B;**[!UICONTROL More]**（三個點的列），然後點選&#x200B;**[!UICONTROL Delete]**。
