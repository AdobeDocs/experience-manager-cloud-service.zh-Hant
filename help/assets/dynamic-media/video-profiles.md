...
請注意，您可以使用使用者介面中「智慧型裁切比例」(**[!UICONTROL Smart Crop Ratio]**)最右側的滑桿，將「視訊描述檔」中的視訊智慧型裁切切換為開啟或關閉。
...
1. 點選 **[!UICONTROL 「將描述檔套用至檔案夾」]** ，然後選取您要用來接收新上傳資產的檔案夾或多個檔案夾，並點選「套 **[!UICONTROL 用」]**。在「卡片檢視」中，資料夾名稱正下方會顯示資料夾名稱，以指出已指派給資料夾的 **[!UICONTROL 資料夾]**。您可以[監控視頻配置檔案處理作業的進度](#monitoring-the-progress-of-an-encoding-job)。
