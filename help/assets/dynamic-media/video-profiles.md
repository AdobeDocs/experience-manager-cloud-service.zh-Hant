...
視訊智慧型裁切是「視訊描述檔」中的選用功能。 此工具會使用Adobe AI自動偵測並裁切您上傳之任何最適化視訊或漸進式視訊中的焦點，而不論大小。
...
Adobe AI限製為9000個畫面。 也就是說，30 FPS時需要5分鐘。 如果您的視訊具有較高的FPS，則支援的視訊持續時間上限會減少。 例如，60 FPS視訊必須長達兩分半鐘，Adobe AI和智慧型裁切才會支援。
