...
>**如果您要升級：**
>
>* 有Adobe [!DNL Experience Manager] 上傳的任何資產都會自動啟用Dynamic Media（除非您的系統管理員明確停用），才能正常運作。 如果您位於 [!DNL Experience Manager] 對Dynamic Media來說，您可能必須重新處理資產，才能啟用Dynamic Media。 請參閱 [重新處理資料夾中的資產](/help/assets/dynamic-media/about-image-video-profiles.md#reprocessing-assets).
