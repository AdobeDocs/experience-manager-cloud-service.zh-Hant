...
* **內嵌准則：**
使用本檔案內嵌每個檢視器特有的准則。
想要進一步瞭解嗎？ 移至AEM Assets [&#128279;](https://experienceleague.adobe.com/zh-hant/docs/dynamic-media-developer-resources/library/viewers-aem-assets-dmc/c-html5-s7-aem-asset-viewers)的檢視器。
* **SDK教學課程與範例：**
