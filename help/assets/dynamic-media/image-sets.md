...
1. [上傳多個檢視的主要來源影像](#uploading-assets-in-image-sets)。
   ...
   上傳影像集的影像。 請記住，使用者可以在「影像集檢視器」中縮放影像。 因此，請謹慎選擇您的影像。 請確定影像大小至少為2000像素。 「Experience Manager資產」支援許多影像檔案格式，但建議使用無損TIFF、PNG和EPS影像。
...
首先，上傳影像集的影像資產。 請記住，使用者可以在「影像集檢視器」中縮放影像。 因此，請謹慎選擇您的影像。 請確定影像大小最大至少為2000像素，以取得最佳縮放細節。 Dynamic Media每幅影像的轉譯率高達2500萬像素。 例如，您可使用5000x5億像素的影像或任何其他大小的組合，最高2500萬像素。
...
若要建立多檢視影像集，您需要顯示來自不同視點的項目或顯示相同項目不同方面的影像。 其目標是強調項目的重要功能，讓檢視者全面瞭解項目的顯示方式或其作用。

由於使用者可以在影像集中縮放影像，因此請確定影像大小最大至少為2000像素。 「Experience Manager資產」支援許多影像檔案格式，但建議使用無損TIFF、PNG和EPS影像。
