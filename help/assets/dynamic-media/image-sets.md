...
1. [建立影像集。](#creating-image-sets)
   ...
   您也可以透過批次集預設集自動 [建立影像集](/help/assets/dynamic-media/config-dm.md#creating-batch-set-presets-to-auto-generate-image-sets-and-spin-sets)。
...
>[!IMPORTANT]
>
>批集由IPS [Image Production system建立] ，作為資產提取的一部分。
