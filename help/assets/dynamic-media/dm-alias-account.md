...
* Dynamic Media的現成可用[快取失效](/help/assets/dynamic-media/invalidate-cdn-cache-dynamic-media.md)功能可讓Cloud Service中Dynamic Media設定頁面中已設定公司和公司別名帳戶的URL失效。
* 當您在&#x200B;**[!UICONTROL 編輯Dynamic Media組態]**&#x200B;頁面上設定公司別名帳戶時，為了成功讓快取失效，您必須同時使&#x200B;** **[!UICONTROL 公司]**&#x200B;帳戶和&#x200B;**[!UICONTROL 公司別名]**&#x200B;帳戶的URL失效。

另請參閱[在Cloud Service中建立Dynamic Media設定](/help/assets/dynamic-media/config-dm.md#configuring-dynamic-media-cloud-services)
