...
## 使用Manage Publication{#selective-publish-manage-publication}將資AEM產選擇性發佈至Dynamic Media或做為Cloud Service
...
**使用「管理出版物」，選擇性地將資AEM產發佈至Dynamic Media或做為Cloud Service**
