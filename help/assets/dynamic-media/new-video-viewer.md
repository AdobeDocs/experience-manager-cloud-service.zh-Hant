---
title: 新視訊檢視器
description: Dynamic Media的全新視訊檢視器提供更優異的視訊播放體驗，包括更優異的效能、協助工具及可設定性。
role: User
...
5. 按一下&#x200B;**URL**以複製預覽連結。
   ![複製URL](/help/assets/assets/Copy-url1.jpg)
...
![拖曳動態媒體元件](/help/assets/assets/drag-component.jpeg)
...
2. 按一下元件工具列中的&#x200B;**設定**。
   ![開啟Dynamic Media設定](/help/assets/assets/configure-asset.png)

3. 在&#x200B;**動態媒體設定對話方塊**&#x200B;中，從&#x200B;**檢視器預設集**&#x200B;下拉式清單中選取&#x200B;**視訊（新增）**。
   ![選取視訊（新）檢視器預設集](/help/assets/assets/viewer-preset.jpeg)

4. 在&#x200B;**檢視器修飾元**&#x200B;欄位中輸入任何必要的修飾元（例如，`autoplay=true&muted=true`）。
   ![檢視器修飾元](/help/assets/assets/additional-modifiers.jpeg)
