...
在Dynamic Media中處理3D資產之前，請確定您的Experience Manager管理員已啟用並設定Dynamic MediaCloud Services。
...
Dynamic Media包含Dynamic Media 3D媒體元件，可在Experience Manager網站中使用，以在網頁上互動式檢視3D模型。
...
1. 若要選取空白區域並開啟其相關的工具列，請點選「**[!UICONTROL 版面容器]**」區域中的空白區域。
...
如果您使用Experience Manager作為網頁內容管理系統，則可以通過3D媒體元件將3D資產添加到網頁中。
...
1. 若要在頁面編輯器中開啟頁面，請點選&#x200B;**[!UICONTROL Edit]**（鉛筆）圖示。 請確定在頁面右上角附近選取了&#x200B;**[!UICONTROL Edit]**&#x200B;模式。
...
1. 在「Details（詳細資訊）」頁面的工具列上，點選&#x200B;**[!UICONTROL Quick Publish]**。
...
如果您是&#x200B;*not*&#x200B;使用Experience Manager作為WCM，請使用下列兩種方法來發佈Dynamic Media 3D資產。
