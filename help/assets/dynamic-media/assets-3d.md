...
![3D鞋](/help/assets/dynamic-media/assets/3d-dimensional-viewer-quickpublish-url-embed2.png)
...
1. 當網頁處於「編 **[!UICONTROL 輯]** 」模式時，請執行下列任一項作業：
   ...
   * 從瀏 `/editor.html` 覽器的頁面URL刪除。
   ![3D資產顯示在3D Media元件內](/help/assets/dynamic-media/assets/3d-asset-in-3d-media.png)：完全互動的3D資產，如「預 **[!UICONTROL 覽]** 」模式所示。
...
1. 從「資產」側面板拖曳3D資產，並將其拖曳至您先前新增至頁面的 **[!UICONTROL 3D Media]** 元件。
   ...
   ![將3D資產指派給3D媒體元件](/help/assets/dynamic-media/assets/3d-asset-add.png)
