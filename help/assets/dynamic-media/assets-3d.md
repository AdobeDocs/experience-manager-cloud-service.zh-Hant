...
另請參閱 [支援的3D格式](/help/assets/file-format-support.md#supported-3d-formats)
...
完全互動的3D資產，如    ![3D資產顯示在3D Media元件內](/help/assets/dynamic-media/assets/3d-asset-in-3d-mediaa.png)：完全互動的3D資產，如「預 **[!UICONTROL 覽]** 」模式所示。
