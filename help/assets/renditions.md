...
1. 按一下![下載圖示](assets/do-not-localize/download-icon.png)，將所有可用的智慧型裁切轉譯下載為單一zip檔案。
   ![下載圖示](/help/assets/assets/download-op.png)
...
* 您必須是授權的AEM Dynamic Media使用者。
* Assets必須獲得核准才能公開使用，才能顯示具有OpenAPI功能轉譯的Dynamic Media。 如需詳細資訊，請參閱[在Experience Manager中核准資產](/help/assets/approve-assets.md#copy-delivery-url-approved-assets)
...
1. 選取資產並按一下&#x200B;**詳細資料**。
1. 按一下右側面板中可用的Dynamic Media圖示。 「動態媒體」面板會視支援的資產型別，酌情顯示基本轉譯、動態轉譯和「智慧型裁切」轉譯。
   ![下載圖示](/help/assets/assets/new-new1.png)
1. 選取&#x200B;**基本轉譯**，然後按一下[複製URL] **以複製資產的傳遞URL，或按一下[下載URL]**&#x200B;下載資產。**&#x200B;**

如果為存放庫同時啟用了Scene7 (Dynamic Media)和具有OpenAPI功能的Dynamic Media ，則使用者介面中會提供切換選項以在兩者之間切換。 顯示的轉譯和產生的URL會根據選取的設定進行更新。

![切換選項](/help/assets/assets/new-new2.png)