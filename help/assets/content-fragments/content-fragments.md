...
透過Adobe Experience Manager (AEM)as a Cloud Service，內容片段可讓您設計、建立、組織和 [發佈獨立於頁面的內容](/help/sites-cloud/authoring/fragments/content-fragments.md). 它們可讓您準備內容以用於多個位置/多個管道，非常適合Headless傳送。 它們也可以搭配 [多網站管理可讓您重複使用內容](#reusing-content-fragments-with-msm).
