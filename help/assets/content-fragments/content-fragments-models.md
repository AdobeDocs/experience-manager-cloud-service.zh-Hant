...
### 在配置瀏覽器中啟用內容片段模型 {#enable-content-fragment-models-in-configuration-browser}

若要 [建立新的內容片段模型](#creating-a-content-fragment-model) ，您 **必須先使用「設定瀏覽器** 」來啟 [用它們：](/help/implementing/developing/introduction/configurations.md#using-configuration-browser)
