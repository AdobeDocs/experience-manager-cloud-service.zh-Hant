...
將AEM Assets與檔案式製作功能整合以供Edge Delivery Services使用，讓網站作者在AEM Assets Word或Google檔案中製作檔案時，能夠使用Microsoft存放庫中的可用影像。 如需詳細資訊，請參閱 [將AEM Assets與檔案式製作整合](/help/edge/using.md#integrate-assets-edge).
