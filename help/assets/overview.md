...
Adobe Experience Manager Assets as a [!DNL Cloud Service]為企業提供雲端原生PaaS解決方案，不僅可快速且有影響力地執行其數位資產管理和動態媒體作業，還可在永遠最新、永遠可用、永遠學習的系統中使用新一代智慧功能，例如AI/ML。
...
首先，瞭解雲端原生產品的[優點](#solution-benefits)。 查看對AEM的顯著[變更(a [!DNL Cloud Service]](/help/release-notes/aem-cloud-changes.md))，這也會影響Experience Manager Assets，接著是對Assets](/help/assets/assets-cloud-changes.md)的顯著變更。[
