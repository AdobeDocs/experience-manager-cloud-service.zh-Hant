...
# 在中編輯視訊 [!DNL Assets view] {#edit-videos}

使用內嵌式功能的Assets使用者，可輕鬆建立視訊內容的變體 [!DNL Adobe Express] 視訊的快速動作。 中的快速動作 [!DNL Assets view] 提供者 [!DNL Adobe Express] 提供方便使用的視訊編輯選項，包括裁切視訊、調整視訊大小、修剪視訊，以及將視訊轉換為GIF。
...
DAM中的最終視訊內容通常需要調整大小，才能發佈到特定管道。 [!DNL Assets view] 可讓您輕鬆調整視訊大小以符合常見社交頻道所需的維度，您也可以根據自訂解析度調整大小。 若要使用調整視訊大小 [!DNL Assets view]，請執行以下步驟：
...
如果您需要使用較大視訊的剪輯，可以使用 **[!UICONTROL 修剪視訊]** 函式來選取及修剪視訊的區段。 執行以下步驟：
...
5. 按一下「**[!UICONTROL 套用]**」。
   ...
   ![使用Adobe Express將視訊轉換為GIF](assets/adobe-express-convert-video-to-gif.png)
...
* 使用提供產品意見回饋 [!UICONTROL 意見反應] 「資產」檢視使用者介面上可用的選項。
...
>[!MORELIKETHIS]
>
>* [在資產檢視中編輯影像](edit-images-assets-view.md)
