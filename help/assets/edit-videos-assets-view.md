...
使用內嵌的[!DNL Adobe Express]視訊快速動作，為Assets使用者輕鬆建立視訊內容的變體。 由[!DNL Assets view]提供支援的[!DNL Adobe Express]中的快速動作可提供方便使用的視訊編輯選項，包括裁切視訊、調整視訊大小、修剪視訊，以及將視訊轉換成GIF。
...
3. 從&#x200B;**[!UICONTROL 下拉式清單的]**&#x200B;調整大小下方的社群媒體平台選取適當的維度。 或者，拖曳視訊邊角上的操作框來建立您想要的裁切。
