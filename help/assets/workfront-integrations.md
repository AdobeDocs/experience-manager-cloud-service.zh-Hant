...
Adobe選件至 [整合 [!DNL Workfront] 和 [!DNL Adobe Experience Manager Assets] 原生(支援Assets Essentials和as a Cloud Service資產)或使用Workfront來增強Experience Manager連接器](https://experienceleague.adobe.com/docs/workfront/using/documents/wf-aem-integrations/wf-aem-essentials/aem-asset-integrations.html). 若是原生整合，您不需要連接器來整合這兩個解決方案。

>[!NOTE]
>
>Adobe不支援使用Workfront來同時Experience Manager增強連接器和Experience Manager整合。
