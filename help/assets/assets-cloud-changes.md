...
description: 與[!DNL Adobe Experience Manager 6.5相比， [!DNL Adobe Experience Manager Assets] in [!DNL Experience Manager] as a [!DNL Cloud Service] 有顯著的變更。
feature: 發行資訊
...
# [!DNL Experience Manager Assets]作為[!DNL Cloud Service] {#notable-changes}的顯著變更
...
## [!DNL Experience Manager] 6.5 {#cloud-service-feature-status}的功能對等
