...
系統會為每個結果指派一個重要性層級，以指出動作的概略優先順序。若要進一步瞭解每個「尋找類別」，請參閱「模 [式偵測器類別」](https://docs.adobe.com/content/help/en/experience-manager-pattern-detection/table-of-contents/aso.html)。
