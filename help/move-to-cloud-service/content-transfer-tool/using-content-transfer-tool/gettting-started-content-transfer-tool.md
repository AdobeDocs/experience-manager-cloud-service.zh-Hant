...
>title="下載"
>abstract="您可以從軟體發佈入口網站下載「內容轉移工具」的ZIP檔案。 您可以透過「封裝管理程式」，在來源 Adobe Experience Manager AEM) 例項上安裝封裝。Make sure to download the latest version."
...
您可以從軟體發佈入口網站下載「內容轉移工具」的ZIP檔案。 您可以透過「封裝管理程式」，在來源 Adobe Experience Manager AEM) 例項上安裝封裝。請務必下載最新版本。 For more details on the latest version, refer to [Release Notes](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/release-notes/release-notes/release-notes-current.html?lang=zh-Hant).
...
1. The console below appears when you create the first migration set. 按一下&#x200B;**建立移轉集**&#x200B;以建立新的移轉集。
...
1. 您將在&#x200B;**內容轉移**&#x200B;精靈中檢視移轉集，如下圖所示。
   ...
   所有現有遷移集都顯示在&#x200B;**內容轉移**&#x200B;嚮導中，並顯示其當前狀態和狀態資訊。 You may see some of these icons described below.
