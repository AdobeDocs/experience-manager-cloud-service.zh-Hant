...
![建立內容片段模式的第二步和第三步](assets/do-not-localize/create-model-2-3.png)

## 新增欄位至模式 {#configure-model}

在使用模式之前，您需要定義其資料結構。內容片段模式編輯器就是您設定定義模式內容的資料類型和屬性的地方。
...
![在模式中新增欄位的第一步、第二步和第三步](assets/do-not-localize/define-model-fields-1-2-3.png)
