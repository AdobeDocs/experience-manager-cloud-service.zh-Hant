...
>title="在本模式中，您已瞭解如何自訂範例 React 應用程式。<br><br>上市時間：加速！<br>開發週期：縮短！<br><br>現在您已了解，對於由 AEM 無周邊功能提供支援的網站和應用程式而言，管理無周邊內容是多麼輕鬆的工作。"
>abstract=""
...
內容片段編輯器會將應用程式的基本版面顯示為頁面內容片段。 **面板**&#x200B;代表應用程式的不同頁面，每個頁面都是自己的內容片段。 透過修訂這些片段，您可以變更應用程式的內容。
