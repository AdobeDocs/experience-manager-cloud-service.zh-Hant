...
>[!NOTE]
>
> 本文所述的某些產品執行個體和產品設定檔可能僅會出現在新建立的環境中。未來的機制也會讓現有環境能夠更新。
...
2024 年 11 月初以前建立的環境，可能缺少上面各區段中描述的組織級產品執行個體以及某些產品設定檔。現有的產品設定檔也會缺少服務切換功能。建議更新這些產品設定檔，因為這是存取某些未來 API 的先決條件。
