...
# 了解構建環境{#understanding-build-environment}
...
Cloud Manager現在支援使用Java 8和Java 11建立客戶專案。 依預設，專案是使用Java 8建置。

若客戶想在其專案中使用Java 11，可使用[Apache Maven工具鏈外掛程式](https://maven.apache.org/plugins/maven-toolchains-plugin/)執行此操作。
