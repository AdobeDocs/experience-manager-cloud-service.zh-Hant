---
title: Adobe Experience Manager雲端服務入門
description: Adobe Experience Manager雲端服務入門自助資源與檔案連結
...
# 以雲端服務身分登入Experience Manager {#aem-onboarding-guide}

本頁列出有關Experience Manager雲端服務入門的自助資源。

## 主要入門文章 {#key-articles}

本節涵蓋以下幾篇重點文章：

* 以雲端服務形式存取Experience manager的需求
* 瞭解控制特定功能可用性的使用者角色
* 設定Cloud Manager Git儲存庫
* 以雲端服務的形式存取Experience Manager
* 資料保護與隱私權法規基礎
