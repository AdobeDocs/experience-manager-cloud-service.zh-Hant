---
title: AEM中Cloud Manager的Cloud Manager版本注意事項2020.6.0版
description: AEM中Cloud Manager的Cloud Manager版本注意事項2020.6.0版
...
# Adobe Experience Manager中Cloud Manager的Cloud Manager版本說明：Cloud Service 2020.6.0 {#release-notes}

本頁概述AEM中Cloud Manager的Release Notes（Cloud Service 2020.6.0版）。

## 發行日期 {#release-date}

AEM中Cloud Manager作為Cloud Service 2020.6.0的發行日期為2020年6月04日。
