...
**使用方式：**&#x200B;從頭開始建立或匯入並轉換（請參閱[快速入門手冊](/help/edge/docs/forms/forms-ai-assistant-getting-started.md)），選擇下列兩種方式之一：
...
**如何使用：**&#x200B;上傳您的來源檔案並描述轉換需求（請參閱[匯入指南](/help/edge/docs/forms/forms-ai-assistant-getting-started.md)）。
