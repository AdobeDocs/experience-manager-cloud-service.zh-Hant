...
>
>
> 此步驟適用於使用[AEM Boilerplate XWalk](https://github.com/adobe-rnd/aem-boilerplate-xwalk)建置的專案。 如果您使用 [AEM Forms 範本](https://github.com/adobe-rnd/aem-boilerplate-forms)建立 AEM 專案，即可省略此步驟。
