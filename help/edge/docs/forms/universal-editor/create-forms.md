...
1. 在&#x200B;**Source**&#x200B;索引標籤中，選取&#x200B;**Edge Delivery Services範本**：
...
1. 按一下&#x200B;**[!UICONTROL 建立]**&#x200B;以建立表單。 現在，您可以[使用通用編輯器](#author-the-form)編寫表單。
...
1. 按一下&#x200B;**[!UICONTROL 建立]**&#x200B;以建立表單。 現在，您可以[使用最適化表單編輯器](#author-the-form)編寫表單。
...
若要在Edge Delivery Services上發佈調適型表單，您需要[在AEM](#create-an-edge-delivery-services-configuration)執行個體上建立Edge Delivery Services設定。
