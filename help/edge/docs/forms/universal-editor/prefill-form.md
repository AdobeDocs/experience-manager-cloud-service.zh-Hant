...
1. 按一下「**完成**」以儲存引數，並按一下「**儲存**」以儲存 FDM
   ...
   >[!NOTE]
   >
   > 了解有關設定 FDM 服務的更多資訊，請參閱[使用表單資料模型 (FDM)](/help/forms/work-with-form-data-model.md)。
...
1. **資料來源擴充功能**
   ...
   >[!TIP]
   >
   > 有關管理擴充功能的詳細說明，請參閱 [Extension Manager 功能重點介紹](https://developer.adobe.com/uix/docs/extension-manager/feature-highlights/#enablingdisabling-extensions?lang=zh-Hant)。
