...
感謝您選擇為 [!UICONTROL Adobe Experience Manager] cloud服務檔案提供內容！ 我們歡迎社群和檔案團隊以外的Adobe員工提供內容。
...
雖然我們歡迎任何改善AEM cloud服務檔案的貢獻，但我們確實要求貢獻符合特定的准則和標準。 請參閱「 [Guidelines for Compitting to AEM Documentation](guidelines.md) 」（AEM檔案貢獻指南），以取得詳細資訊。
